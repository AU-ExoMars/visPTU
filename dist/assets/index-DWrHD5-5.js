...
`)+`
`+f);const b=T+m+a,y=T+f+o,w=Cl(i,i.VERTEX_SHADER,b),C=Cl(i,i.FRAGMENT_SHADER,y);i.attachShader(x,w),i.attachShader(x,C),t.index0AttributeName!==void 0?i.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(x,0,"position"),i.linkProgram(x);function R(P){if(s.debug.checkShaderErrors){const k=i.getProgramInfoLog(x)||"",G=i.getShaderInfoLog(w)||"",j=i.getShaderInfoLog(C)||"",X=k.trim(),Y=G.trim(),$=j.trim();let z=!0,le=!0;if(i.getProgramParameter(x,i.LINK_STATUS)===!1)if(z=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,x,w,C);else{const pe=Ll(i,w,"vertex"),Ee=Ll(i,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(x,i.VALIDATE_STATUS)+`
...
Program Info Log: `+X+`
`+pe+`
`+Ee)}else X!==""?console.warn("THREE.WebGLProgram: Program Info Log:",X):(Y===""||$==="")&&(le=!1);le&&(P.diagnostics={runnable:z,programLog:X,vertexShader:{log:Y,prefix:m},fragmentShader:{log:$,prefix:f}})}i.deleteShader(w),i.deleteShader(C),F=new Qs(i,x),S=ag(i,x)}let F;this.getUniforms=function(){return F===void 0&&R(this),F};let S;this.getAttributes=function(){return S===void 0&&R(this),S};let M=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return M===!1&&(M=i.getProgramParameter(x,Zm)),M},this.destroy=function(){n.releaseStatesOfProgram(this),i.deleteProgram(x),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Jm++,this.cacheKey=e,this.usedTimes=1,this.program=x,this.vertexShader=w,this.fragmentShader=C,this}let xg=0;class vg{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,i=this._getShaderStage(t),r=this._getShaderStage(n),a=this._getShaderCacheForMaterial(e);return a.has(i)===!1&&(a.add(i),i.usedTimes++),a.has(r)===!1&&(a.add(r),r.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new Mg(e),t.set(e,n)),n}}class Mg{constructor(e){this.id=xg++,this.code=e,this.usedTimes=0}}function yg(s,e,t,n,i,r,a){const o=new cc,c=new vg,l=new Set,h=[],u=i.logarithmicDepthBuffer,d=i.vertexTextures;let p=i.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function x(S){return l.add(S),S===0?"uv":`uv${S}`}function m(S,M,P,k,G){const j=k.fog,X=G.geometry,Y=S.isMeshStandardMaterial?k.environment:null,$=(S.isMeshStandardMaterial?t:e).get(S.envMap||Y),z=$&&$.mapping===sr?$.image.height:null,le=g[S.type];S.precision!==null&&(p=i.getMaxPrecision(S.precision),p!==S.precision&&console.warn("THREE.WebGLProgram.getParameters:",S.precision,"not supported, using",p,"instead."));const pe=X.morphAttributes.position||X.morphAttributes.normal||X.morphAttributes.color,Ee=pe!==void 0?pe.length:0;let Oe=0;X.morphAttributes.position!==void 0&&(Oe=1),X.morphAttributes.normal!==void 0&&(Oe=2),X.morphAttributes.color!==void 0&&(Oe=3);let qe,Je,We,W;if(le){const Qe=cn[le];qe=Qe.vertexShader,Je=Qe.fragmentShader}else qe=S.vertexShader,Je=S.fragmentShader,c.update(S),We=c.getVertexShaderID(S),W=c.getFragmentShaderID(S);const K=s.getRenderTarget(),me=s.state.buffers.depth.getReversed(),Ce=G.isInstancedMesh===!0,ye=G.isBatchedMesh===!0,He=!!S.map,at=!!S.matcap,A=!!$,$e=!!S.aoMap,De=!!S.lightMap,be=!!S.bumpMap,ve=!!S.normalMap,Xe=!!S.displacementMap,ge=!!S.emissiveMap,Ue=!!S.metalnessMap,ct=!!S.roughnessMap,Ke=S.anisotropy>0,E=S.clearcoat>0,_=S.dispersion>0,N=S.iridescence>0,H=S.sheen>0,J=S.transmission>0,V=Ke&&!!S.anisotropyMap,Q=E&&!!S.clearcoatMap,ee=E&&!!S.clearcoatNormalMap,ue=E&&!!S.clearcoatRoughnessMap,de=N&&!!S.iridescenceMap,Z=N&&!!S.iridescenceThicknessMap,ie=H&&!!S.sheenColorMap,ce=H&&!!S.sheenRoughnessMap,re=!!S.specularMap,ae=!!S.specularColorMap,Te=!!S.specularIntensityMap,L=J&&!!S.transmissionMap,se=J&&!!S.thicknessMap,oe=!!S.gradientMap,xe=!!S.alphaMap,te=S.alphaTest>0,q=!!S.alphaHash,Se=!!S.extensions;let Ne=Hn;S.toneMapped&&(K===null||K.isXRRenderTarget===!0)&&(Ne=s.toneMapping);const ot={shaderID:le,shaderType:S.type,shaderName:S.name,vertexShader:qe,fragmentShader:Je,defines:S.defines,customVertexShaderID:We,customFragmentShaderID:W,isRawShaderMaterial:S.isRawShaderMaterial===!0,glslVersion:S.glslVersion,precision:p,batching:ye,batchingColor:ye&&G._colorsTexture!==null,instancing:Ce,instancingColor:Ce&&G.instanceColor!==null,instancingMorph:Ce&&G.morphTexture!==null,supportsVertexTextures:d,outputColorSpace:K===null?s.outputColorSpace:K.isXRRenderTarget===!0?K.texture.colorSpace:Dt,alphaToCoverage:!!S.alphaToCoverage,map:He,matcap:at,envMap:A,envMapMode:A&&$.mapping,envMapCubeUVHeight:z,aoMap:$e,lightMap:De,bumpMap:be,normalMap:ve,displacementMap:d&&Xe,emissiveMap:ge,normalMapObjectSpace:ve&&S.normalMapType===yh,normalMapTangentSpace:ve&&S.normalMapType===Ka,metalnessMap:Ue,roughnessMap:ct,anisotropy:Ke,anisotropyMap:V,clearcoat:E,clearcoatMap:Q,clearcoatNormalMap:ee,clearcoatRoughnessMap:ue,dispersion:_,iridescence:N,iridescenceMap:de,iridescenceThicknessMap:Z,sheen:H,sheenColorMap:ie,sheenRoughnessMap:ce,specularMap:re,specularColorMap:ae,specularIntensityMap:Te,transmission:J,transmissionMap:L,thicknessMap:se,gradientMap:oe,opaque:S.transparent===!1&&S.blending===Ai&&S.alphaToCoverage===!1,alphaMap:xe,alphaTest:te,alphaHash:q,combine:S.combine,mapUv:He&&x(S.map.channel),aoMapUv:$e&&x(S.aoMap.channel),lightMapUv:De&&x(S.lightMap.channel),bumpMapUv:be&&x(S.bumpMap.channel),normalMapUv:ve&&x(S.normalMap.channel),displacementMapUv:Xe&&x(S.displacementMap.channel),emissiveMapUv:ge&&x(S.emissiveMap.channel),metalnessMapUv:Ue&&x(S.metalnessMap.channel),roughnessMapUv:ct&&x(S.roughnessMap.channel),anisotropyMapUv:V&&x(S.anisotropyMap.channel),clearcoatMapUv:Q&&x(S.clearcoatMap.channel),clearcoatNormalMapUv:ee&&x(S.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ue&&x(S.clearcoatRoughnessMap.channel),iridescenceMapUv:de&&x(S.iridescenceMap.channel),iridescenceThicknessMapUv:Z&&x(S.iridescenceThicknessMap.channel),sheenColorMapUv:ie&&x(S.sheenColorMap.channel),sheenRoughnessMapUv:ce&&x(S.sheenRoughnessMap.channel),specularMapUv:re&&x(S.specularMap.channel),specularColorMapUv:ae&&x(S.specularColorMap.channel),specularIntensityMapUv:Te&&x(S.specularIntensityMap.channel),transmissionMapUv:L&&x(S.transmissionMap.channel),thicknessMapUv:se&&x(S.thicknessMap.channel),alphaMapUv:xe&&x(S.alphaMap.channel),vertexTangents:!!X.attributes.tangent&&(ve||Ke),vertexColors:S.vertexColors,vertexAlphas:S.vertexColors===!0&&!!X.attributes.color&&X.attributes.color.itemSize===4,pointsUvs:G.isPoints===!0&&!!X.attributes.uv&&(He||xe),fog:!!j,useFog:S.fog===!0,fogExp2:!!j&&j.isFogExp2,flatShading:S.flatShading===!0&&S.wireframe===!1,sizeAttenuation:S.sizeAttenuation===!0,logarithmicDepthBuffer:u,reversedDepthBuffer:me,skinning:G.isSkinnedMesh===!0,morphTargets:X.morphAttributes.position!==void 0,morphNormals:X.morphAttributes.normal!==void 0,morphColors:X.morphAttributes.color!==void 0,morphTargetsCount:Ee,morphTextureStride:Oe,numDirLights:M.directional.length,numPointLights:M.point.length,numSpotLights:M.spot.length,numSpotLightMaps:M.spotLightMap.length,numRectAreaLights:M.rectArea.length,numHemiLights:M.hemi.length,numDirLightShadows:M.directionalShadowMap.length,numPointLightShadows:M.pointShadowMap.length,numSpotLightShadows:M.spotShadowMap.length,numSpotLightShadowsWithMaps:M.numSpotLightShadowsWithMaps,numLightProbes:M.numLightProbes,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:S.dithering,shadowMapEnabled:s.shadowMap.enabled&&P.length>0,shadowMapType:s.shadowMap.type,toneMapping:Ne,decodeVideoTexture:He&&S.map.isVideoTexture===!0&&Ye.getTransfer(S.map.colorSpace)===it,decodeVideoTextureEmissive:ge&&S.emissiveMap.isVideoTexture===!0&&Ye.getTransfer(S.emissiveMap.colorSpace)===it,premultipliedAlpha:S.premultipliedAlpha,doubleSided:S.side===Nt,flipSided:S.side===Ft,useDepthPacking:S.depthPacking>=0,depthPacking:S.depthPacking||0,index0AttributeName:S.index0AttributeName,extensionClipCullDistance:Se&&S.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Se&&S.extensions.multiDraw===!0||ye)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:S.customProgramCacheKey()};return ot.vertexUv1s=l.has(1),ot.vertexUv2s=l.has(2),ot.vertexUv3s=l.has(3),l.clear(),ot}function f(S){const M=[];if(S.shaderID?M.push(S.shaderID):(M.push(S.customVertexShaderID),M.push(S.customFragmentShaderID)),S.defines!==void 0)for(const P in S.defines)M.push(P),M.push(S.defines[P]);return S.isRawShaderMaterial===!1&&(T(M,S),b(M,S),M.push(s.outputColorSpace)),M.push(S.customProgramCacheKey),M.join()}function T(S,M){S.push(M.precision),S.push(M.outputColorSpace),S.push(M.envMapMode),S.push(M.envMapCubeUVHeight),S.push(M.mapUv),S.push(M.alphaMapUv),S.push(M.lightMapUv),S.push(M.aoMapUv),S.push(M.bumpMapUv),S.push(M.normalMapUv),S.push(M.displacementMapUv),S.push(M.emissiveMapUv),S.push(M.metalnessMapUv),S.push(M.roughnessMapUv),S.push(M.anisotropyMapUv),S.push(M.clearcoatMapUv),S.push(M.clearcoatNormalMapUv),S.push(M.clearcoatRoughnessMapUv),S.push(M.iridescenceMapUv),S.push(M.iridescenceThicknessMapUv),S.push(M.sheenColorMapUv),S.push(M.sheenRoughnessMapUv),S.push(M.specularMapUv),S.push(M.specularColorMapUv),S.push(M.specularIntensityMapUv),S.push(M.transmissionMapUv),S.push(M.thicknessMapUv),S.push(M.combine),S.push(M.fogExp2),S.push(M.sizeAttenuation),S.push(M.morphTargetsCount),S.push(M.morphAttributeCount),S.push(M.numDirLights),S.push(M.numPointLights),S.push(M.numSpotLights),S.push(M.numSpotLightMaps),S.push(M.numHemiLights),S.push(M.numRectAreaLights),S.push(M.numDirLightShadows),S.push(M.numPointLightShadows),S.push(M.numSpotLightShadows),S.push(M.numSpotLightShadowsWithMaps),S.push(M.numLightProbes),S.push(M.shadowMapType),S.push(M.toneMapping),S.push(M.numClippingPlanes),S.push(M.numClipIntersection),S.push(M.depthPacking)}function b(S,M){o.disableAll(),M.supportsVertexTextures&&o.enable(0),M.instancing&&o.enable(1),M.instancingColor&&o.enable(2),M.instancingMorph&&o.enable(3),M.matcap&&o.enable(4),M.envMap&&o.enable(5),M.normalMapObjectSpace&&o.enable(6),M.normalMapTangentSpace&&o.enable(7),M.clearcoat&&o.enable(8),M.iridescence&&o.enable(9),M.alphaTest&&o.enable(10),M.vertexColors&&o.enable(11),M.vertexAlphas&&o.enable(12),M.vertexUv1s&&o.enable(13),M.vertexUv2s&&o.enable(14),M.vertexUv3s&&o.enable(15),M.vertexTangents&&o.enable(16),M.anisotropy&&o.enable(17),M.alphaHash&&o.enable(18),M.batching&&o.enable(19),M.dispersion&&o.enable(20),M.batchingColor&&o.enable(21),M.gradientMap&&o.enable(22),S.push(o.mask),o.disableAll(),M.fog&&o.enable(0),M.useFog&&o.enable(1),M.flatShading&&o.enable(2),M.logarithmicDepthBuffer&&o.enable(3),M.reversedDepthBuffer&&o.enable(4),M.skinning&&o.enable(5),M.morphTargets&&o.enable(6),M.morphNormals&&o.enable(7),M.morphColors&&o.enable(8),M.premultipliedAlpha&&o.enable(9),M.shadowMapEnabled&&o.enable(10),M.doubleSided&&o.enable(11),M.flipSided&&o.enable(12),M.useDepthPacking&&o.enable(13),M.dithering&&o.enable(14),M.transmission&&o.enable(15),M.sheen&&o.enable(16),M.opaque&&o.enable(17),M.pointsUvs&&o.enable(18),M.decodeVideoTexture&&o.enable(19),M.decodeVideoTextureEmissive&&o.enable(20),M.alphaToCoverage&&o.enable(21),S.push(o.mask)}function y(S){const M=g[S.type];let P;if(M){const k=cn[M];P=uu.clone(k.uniforms)}else P=S.uniforms;return P}function w(S,M){let P;for(let k=0,G=h.length;k<G;k++){const j=h[k];if(j.cacheKey===M){P=j,++P.usedTimes;break}}return P===void 0&&(P=new _g(s,M,S,r),h.push(P)),P}function C(S){if(--S.usedTimes===0){const M=h.indexOf(S);h[M]=h[h.length-1],h.pop(),S.destroy()}}function R(S){c.remove(S)}function F(){c.dispose()}return{getParameters:m,getProgramCacheKey:f,getUniforms:y,acquireProgram:w,releaseProgram:C,releaseShaderCache:R,programs:h,dispose:F}}function Sg(){let s=new WeakMap;function e(a){return s.has(a)}function t(a){let o=s.get(a);return o===void 0&&(o={},s.set(a,o)),o}function n(a){s.delete(a)}function i(a,o,c){s.get(a)[o]=c}function r(){s=new WeakMap}return{has:e,get:t,remove:n,update:i,dispose:r}}function Eg(s,e){return s.groupOrder!==e.groupOrder?s.groupOrder-e.groupOrder:s.renderOrder!==e.renderOrder?s.renderOrder-e.renderOrder:s.material.id!==e.material.id?s.material.id-e.material.id:s.z!==e.z?s.z-e.z:s.id-e.id}function Fl(s,e){return s.groupOrder!==e.groupOrder?s.groupOrder-e.groupOrder:s.renderOrder!==e.renderOrder?s.renderOrder-e.renderOrder:s.z!==e.z?e.z-s.z:s.id-e.id}function Ol(){const s=[];let e=0;const t=[],n=[],i=[];function r(){e=0,t.length=0,n.length=0,i.length=0}function a(u,d,p,g,x,m){let f=s[e];return f===void 0?(f={id:u.id,object:u,geometry:d,material:p,groupOrder:g,renderOrder:u.renderOrder,z:x,group:m},s[e]=f):(f.id=u.id,f.object=u,f.geometry=d,f.material=p,f.groupOrder=g,f.renderOrder=u.renderOrder,f.z=x,f.group=m),e++,f}function o(u,d,p,g,x,m){const f=a(u,d,p,g,x,m);p.transmission>0?n.push(f):p.transparent===!0?i.push(f):t.push(f)}function c(u,d,p,g,x,m){const f=a(u,d,p,g,x,m);p.transmission>0?n.unshift(f):p.transparent===!0?i.unshift(f):t.unshift(f)}function l(u,d){t.length>1&&t.sort(u||Eg),n.length>1&&n.sort(d||Fl),i.length>1&&i.sort(d||Fl)}function h(){for(let u=e,d=s.length;u<d;u++){const p=s[u];if(p.id===null)break;p.id=null,p.object=null,p.geometry=null,p.material=null,p.group=null}}return{opaque:t,transmissive:n,transparent:i,init:r,push:o,unshift:c,finish:h,sort:l}}function bg(){let s=new WeakMap;function e(n,i){const r=s.get(n);let a;return r===void 0?(a=new Ol,s.set(n,[a])):i>=r.length?(a=new Ol,r.push(a)):a=r[i],a}function t(){s=new WeakMap}return{get:e,dispose:t}}function Tg(){const s={};return{get:function(e){if(s[e.id]!==void 0)return s[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new D,color:new we};break;case"SpotLight":t={position:new D,direction:new D,color:new we,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new D,color:new we,distance:0,decay:0};break;case"HemisphereLight":t={direction:new D,skyColor:new we,groundColor:new we};break;case"RectAreaLight":t={color:new we,position:new D,halfWidth:new D,halfHeight:new D};break}return s[e.id]=t,t}}}function Ag(){const s={};return{get:function(e){if(s[e.id]!==void 0)return s[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Le};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Le};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Le,shadowCameraNear:1,shadowCameraFar:1e3};break}return s[e.id]=t,t}}}let wg=0;function Rg(s,e){return(e.castShadow?2:0)-(s.castShadow?2:0)+(e.map?1:0)-(s.map?1:0)}function Cg(s){const e=new Tg,t=Ag(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let l=0;l<9;l++)n.probe.push(new D);const i=new D,r=new ke,a=new ke;function o(l){let h=0,u=0,d=0;for(let S=0;S<9;S++)n.probe[S].set(0,0,0);let p=0,g=0,x=0,m=0,f=0,T=0,b=0,y=0,w=0,C=0,R=0;l.sort(Rg);for(let S=0,M=l.length;S<M;S++){const P=l[S],k=P.color,G=P.intensity,j=P.distance,X=P.shadow&&P.shadow.map?P.shadow.map.texture:null;if(P.isAmbientLight)h+=k.r*G,u+=k.g*G,d+=k.b*G;else if(P.isLightProbe){for(let Y=0;Y<9;Y++)n.probe[Y].addScaledVector(P.sh.coefficients[Y],G);R++}else if(P.isDirectionalLight){const Y=e.get(P);if(Y.color.copy(P.color).multiplyScalar(P.intensity),P.castShadow){const $=P.shadow,z=t.get(P);z.shadowIntensity=$.intensity,z.shadowBias=$.bias,z.shadowNormalBias=$.normalBias,z.shadowRadius=$.radius,z.shadowMapSize=$.mapSize,n.directionalShadow[p]=z,n.directionalShadowMap[p]=X,n.directionalShadowMatrix[p]=P.shadow.matrix,T++}n.directional[p]=Y,p++}else if(P.isSpotLight){const Y=e.get(P);Y.position.setFromMatrixPosition(P.matrixWorld),Y.color.copy(k).multiplyScalar(G),Y.distance=j,Y.coneCos=Math.cos(P.angle),Y.penumbraCos=Math.cos(P.angle*(1-P.penumbra)),Y.decay=P.decay,n.spot[x]=Y;const $=P.shadow;if(P.map&&(n.spotLightMap[w]=P.map,w++,$.updateMatrices(P),P.castShadow&&C++),n.spotLightMatrix[x]=$.matrix,P.castShadow){const z=t.get(P);z.shadowIntensity=$.intensity,z.shadowBias=$.bias,z.shadowNormalBias=$.normalBias,z.shadowRadius=$.radius,z.shadowMapSize=$.mapSize,n.spotShadow[x]=z,n.spotShadowMap[x]=X,y++}x++}else if(P.isRectAreaLight){const Y=e.get(P);Y.color.copy(k).multiplyScalar(G),Y.halfWidth.set(P.width*.5,0,0),Y.halfHeight.set(0,P.height*.5,0),n.rectArea[m]=Y,m++}else if(P.isPointLight){const Y=e.get(P);if(Y.color.copy(P.color).multiplyScalar(P.intensity),Y.distance=P.distance,Y.decay=P.decay,P.castShadow){const $=P.shadow,z=t.get(P);z.shadowIntensity=$.intensity,z.shadowBias=$.bias,z.shadowNormalBias=$.normalBias,z.shadowRadius=$.radius,z.shadowMapSize=$.mapSize,z.shadowCameraNear=$.camera.near,z.shadowCameraFar=$.camera.far,n.pointShadow[g]=z,n.pointShadowMap[g]=X,n.pointShadowMatrix[g]=P.shadow.matrix,b++}n.point[g]=Y,g++}else if(P.isHemisphereLight){const Y=e.get(P);Y.skyColor.copy(P.color).multiplyScalar(G),Y.groundColor.copy(P.groundColor).multiplyScalar(G),n.hemi[f]=Y,f++}}m>0&&(s.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=he.LTC_FLOAT_1,n.rectAreaLTC2=he.LTC_FLOAT_2):(n.rectAreaLTC1=he.LTC_HALF_1,n.rectAreaLTC2=he.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=u,n.ambient[2]=d;const F=n.hash;(F.directionalLength!==p||F.pointLength!==g||F.spotLength!==x||F.rectAreaLength!==m||F.hemiLength!==f||F.numDirectionalShadows!==T||F.numPointShadows!==b||F.numSpotShadows!==y||F.numSpotMaps!==w||F.numLightProbes!==R)&&(n.directional.length=p,n.spot.length=x,n.rectArea.length=m,n.point.length=g,n.hemi.length=f,n.directionalShadow.length=T,n.directionalShadowMap.length=T,n.pointShadow.length=b,n.pointShadowMap.length=b,n.spotShadow.length=y,n.spotShadowMap.length=y,n.directionalShadowMatrix.length=T,n.pointShadowMatrix.length=b,n.spotLightMatrix.length=y+w-C,n.spotLightMap.length=w,n.numSpotLightShadowsWithMaps=C,n.numLightProbes=R,F.directionalLength=p,F.pointLength=g,F.spotLength=x,F.rectAreaLength=m,F.hemiLength=f,F.numDirectionalShadows=T,F.numPointShadows=b,F.numSpotShadows=y,F.numSpotMaps=w,F.numLightProbes=R,n.version=wg++)}function c(l,h){let u=0,d=0,p=0,g=0,x=0;const m=h.matrixWorldInverse;for(let f=0,T=l.length;f<T;f++){const b=l[f];if(b.isDirectionalLight){const y=n.directional[u];y.direction.setFromMatrixPosition(b.matrixWorld),i.setFromMatrixPosition(b.target.matrixWorld),y.direction.sub(i),y.direction.transformDirection(m),u++}else if(b.isSpotLight){const y=n.spot[p];y.position.setFromMatrixPosition(b.matrixWorld),y.position.applyMatrix4(m),y.direction.setFromMatrixPosition(b.matrixWorld),i.setFromMatrixPosition(b.target.matrixWorld),y.direction.sub(i),y.direction.transformDirection(m),p++}else if(b.isRectAreaLight){const y=n.rectArea[g];y.position.setFromMatrixPosition(b.matrixWorld),y.position.applyMatrix4(m),a.identity(),r.copy(b.matrixWorld),r.premultiply(m),a.extractRotation(r),y.halfWidth.set(b.width*.5,0,0),y.halfHeight.set(0,b.height*.5,0),y.halfWidth.applyMatrix4(a),y.halfHeight.applyMatrix4(a),g++}else if(b.isPointLight){const y=n.point[d];y.position.setFromMatrixPosition(b.matrixWorld),y.position.applyMatrix4(m),d++}else if(b.isHemisphereLight){const y=n.hemi[x];y.direction.setFromMatrixPosition(b.matrixWorld),y.direction.transformDirection(m),x++}}}return{setup:o,setupView:c,state:n}}function Bl(s){const e=new Cg(s),t=[],n=[];function i(h){l.camera=h,t.length=0,n.length=0}function r(h){t.push(h)}function a(h){n.push(h)}function o(){e.setup(t)}function c(h){e.setupView(t,h)}const l={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:i,state:l,setupLights:o,setupLightsView:c,pushLight:r,pushShadow:a}}function Pg(s){let e=new WeakMap;function t(i,r=0){const a=e.get(i);let o;return a===void 0?(o=new Bl(s),e.set(i,[o])):r>=a.length?(o=new Bl(s),a.push(o)):o=a[r],o}function n(){e=new WeakMap}return{get:t,dispose:n}}const Lg=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function Ig(s,e,t){let n=new no;const i=new Le,r=new Le,a=new Ze,o=new Pu({depthPacking:Mh}),c=new Lu,l={},h=t.maxTextureSize,u={[Rn]:Ft,[Ft]:Rn,[Nt]:Nt},d=new Gn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Le},radius:{value:4}},vertexShader:Lg,fragmentShader:Dg}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const g=new rn;g.setAttribute("position",new Lt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new Pt(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=jl;let f=this.type;this.render=function(C,R,F){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||C.length===0)return;const S=s.getRenderTarget(),M=s.getActiveCubeFace(),P=s.getActiveMipmapLevel(),k=s.state;k.setBlending(zn),k.buffers.depth.getReversed()===!0?k.buffers.color.setClear(0,0,0,0):k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);const G=f!==En&&this.type===En,j=f===En&&this.type!==En;for(let X=0,Y=C.length;X<Y;X++){const $=C[X],z=$.shadow;if(z===void 0){console.warn("THREE.WebGLShadowMap:",$,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;i.copy(z.mapSize);const le=z.getFrameExtents();if(i.multiply(le),r.copy(z.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(r.x=Math.floor(h/le.x),i.x=r.x*le.x,z.mapSize.x=r.x),i.y>h&&(r.y=Math.floor(h/le.y),i.y=r.y*le.y,z.mapSize.y=r.y)),z.map===null||G===!0||j===!0){const Ee=this.type!==En?{minFilter:At,magFilter:At}:{};z.map!==null&&z.map.dispose(),z.map=new ii(i.x,i.y,Ee),z.map.texture.name=$.name+".shadowMap",z.camera.updateProjectionMatrix()}s.setRenderTarget(z.map),s.clear();const pe=z.getViewportCount();for(let Ee=0;Ee<pe;Ee++){const Oe=z.getViewport(Ee);a.set(r.x*Oe.x,r.y*Oe.y,r.x*Oe.z,r.y*Oe.w),k.viewport(a),z.updateMatrices($,Ee),n=z.getFrustum(),y(R,F,z.camera,$,this.type)}z.isPointLightShadow!==!0&&this.type===En&&T(z,F),z.needsUpdate=!1}f=this.type,m.needsUpdate=!1,s.setRenderTarget(S,M,P)};function T(C,R){const F=e.update(x);d.defines.VSM_SAMPLES!==C.blurSamples&&(d.defines.VSM_SAMPLES=C.blurSamples,p.defines.VSM_SAMPLES=C.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new ii(i.x,i.y)),d.uniforms.shadow_pass.value=C.map.texture,d.uniforms.resolution.value=C.mapSize,d.uniforms.radius.value=C.radius,s.setRenderTarget(C.mapPass),s.clear(),s.renderBufferDirect(R,null,F,d,x,null),p.uniforms.shadow_pass.value=C.mapPass.texture,p.uniforms.resolution.value=C.mapSize,p.uniforms.radius.value=C.radius,s.setRenderTarget(C.map),s.clear(),s.renderBufferDirect(R,null,F,p,x,null)}function b(C,R,F,S){let M=null;const P=F.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(P!==void 0)M=P;else if(M=F.isPointLight===!0?c:o,s.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const k=M.uuid,G=R.uuid;let j=l[k];j===void 0&&(j={},l[k]=j);let X=j[G];X===void 0&&(X=M.clone(),j[G]=X,R.addEventListener("dispose",w)),M=X}if(M.visible=R.visible,M.wireframe=R.wireframe,S===En?M.side=R.shadowSide!==null?R.shadowSide:R.side:M.side=R.shadowSide!==null?R.shadowSide:u[R.side],M.alphaMap=R.alphaMap,M.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,M.map=R.map,M.clipShadows=R.clipShadows,M.clippingPlanes=R.clippingPlanes,M.clipIntersection=R.clipIntersection,M.displacementMap=R.displacementMap,M.displacementScale=R.displacementScale,M.displacementBias=R.displacementBias,M.wireframeLinewidth=R.wireframeLinewidth,M.linewidth=R.linewidth,F.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const k=s.properties.get(M);k.light=F}return M}function y(C,R,F,S,M){if(C.visible===!1)return;if(C.layers.test(R.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&M===En)&&(!C.frustumCulled||n.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,C.matrixWorld);const G=e.update(C),j=C.material;if(Array.isArray(j)){const X=G.groups;for(let Y=0,$=X.length;Y<$;Y++){const z=X[Y],le=j[z.materialIndex];if(le&&le.visible){const pe=b(C,le,S,M);C.onBeforeShadow(s,C,R,F,G,pe,z),s.renderBufferDirect(F,null,G,pe,C,z),C.onAfterShadow(s,C,R,F,G,pe,z)}}}else if(j.visible){const X=b(C,j,S,M);C.onBeforeShadow(s,C,R,F,G,X,null),s.renderBufferDirect(F,null,G,X,C,null),C.onAfterShadow(s,C,R,F,G,X,null)}}const k=C.children;for(let G=0,j=k.length;G<j;G++)y(k[G],R,F,S,M)}function w(C){C.target.removeEventListener("dispose",w);for(const F in l){const S=l[F],M=C.target.uuid;M in S&&(S[M].dispose(),delete S[M])}}}const Ug={[Kr]:Zr,[Jr]:ta,[Qr]:na,[Ci]:ea,[Zr]:Kr,[ta]:Jr,[na]:Qr,[ea]:Ci};function Ng(s,e){function t(){let L=!1;const se=new Ze;let oe=null;const xe=new Ze(0,0,0,0);return{setMask:function(te){oe!==te&&!L&&(s.colorMask(te,te,te,te),oe=te)},setLocked:function(te){L=te},setClear:function(te,q,Se,Ne,ot){ot===!0&&(te*=Ne,q*=Ne,Se*=Ne),se.set(te,q,Se,Ne),xe.equals(se)===!1&&(s.clearColor(te,q,Se,Ne),xe.copy(se))},reset:function(){L=!1,oe=null,xe.set(-1,0,0,0)}}}function n(){let L=!1,se=!1,oe=null,xe=null,te=null;return{setReversed:function(q){if(se!==q){const Se=e.get("EXT_clip_control");q?Se.clipControlEXT(Se.LOWER_LEFT_EXT,Se.ZERO_TO_ONE_EXT):Se.clipControlEXT(Se.LOWER_LEFT_EXT,Se.NEGATIVE_ONE_TO_ONE_EXT),se=q;const Ne=te;te=null,this.setClear(Ne)}},getReversed:function(){return se},setTest:function(q){q?K(s.DEPTH_TEST):me(s.DEPTH_TEST)},setMask:function(q){oe!==q&&!L&&(s.depthMask(q),oe=q)},setFunc:function(q){if(se&&(q=Ug[q]),xe!==q){switch(q){case Kr:s.depthFunc(s.NEVER);break;case Zr:s.depthFunc(s.ALWAYS);break;case Jr:s.depthFunc(s.LESS);break;case Ci:s.depthFunc(s.LEQUAL);break;case Qr:s.depthFunc(s.EQUAL);break;case ea:s.depthFunc(s.GEQUAL);break;case ta:s.depthFunc(s.GREATER);break;case na:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}xe=q}},setLocked:function(q){L=q},setClear:function(q){te!==q&&(se&&(q=1-q),s.clearDepth(q),te=q)},reset:function(){L=!1,oe=null,xe=null,te=null,se=!1}}}function i(){let L=!1,se=null,oe=null,xe=null,te=null,q=null,Se=null,Ne=null,ot=null;return{setTest:function(Qe){L||(Qe?K(s.STENCIL_TEST):me(s.STENCIL_TEST))},setMask:function(Qe){se!==Qe&&!L&&(s.stencilMask(Qe),se=Qe)},setFunc:function(Qe,gn,on){(oe!==Qe||xe!==gn||te!==on)&&(s.stencilFunc(Qe,gn,on),oe=Qe,xe=gn,te=on)},setOp:function(Qe,gn,on){(q!==Qe||Se!==gn||Ne!==on)&&(s.stencilOp(Qe,gn,on),q=Qe,Se=gn,Ne=on)},setLocked:function(Qe){L=Qe},setClear:function(Qe){ot!==Qe&&(s.clearStencil(Qe),ot=Qe)},reset:function(){L=!1,se=null,oe=null,xe=null,te=null,q=null,Se=null,Ne=null,ot=null}}}const r=new t,a=new n,o=new i,c=new WeakMap,l=new WeakMap;let h={},u={},d=new WeakMap,p=[],g=null,x=!1,m=null,f=null,T=null,b=null,y=null,w=null,C=null,R=new we(0,0,0),F=0,S=!1,M=null,P=null,k=null,G=null,j=null;const X=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Y=!1,$=0;const z=s.getParameter(s.VERSION);z.indexOf("WebGL")!==-1?($=parseFloat(/^WebGL (\d)/.exec(z)[1]),Y=$>=1):z.indexOf("OpenGL ES")!==-1&&($=parseFloat(/^OpenGL ES (\d)/.exec(z)[1]),Y=$>=2);let le=null,pe={};const Ee=s.getParameter(s.SCISSOR_BOX),Oe=s.getParameter(s.VIEWPORT),qe=new Ze().fromArray(Ee),Je=new Ze().fromArray(Oe);function We(L,se,oe,xe){const te=new Uint8Array(4),q=s.createTexture();s.bindTexture(L,q),s.texParameteri(L,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(L,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let Se=0;Se<oe;Se++)L===s.TEXTURE_3D||L===s.TEXTURE_2D_ARRAY?s.texImage3D(se,0,s.RGBA,1,1,xe,0,s.RGBA,s.UNSIGNED_BYTE,te):s.texImage2D(se+Se,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,te);return q}const W={};W[s.TEXTURE_2D]=We(s.TEXTURE_2D,s.TEXTURE_2D,1),W[s.TEXTURE_CUBE_MAP]=We(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),W[s.TEXTURE_2D_ARRAY]=We(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),W[s.TEXTURE_3D]=We(s.TEXTURE_3D,s.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),K(s.DEPTH_TEST),a.setFunc(Ci),be(!1),ve(yo),K(s.CULL_FACE),$e(zn);function K(L){h[L]!==!0&&(s.enable(L),h[L]=!0)}function me(L){h[L]!==!1&&(s.disable(L),h[L]=!1)}function Ce(L,se){return u[L]!==se?(s.bindFramebuffer(L,se),u[L]=se,L===s.DRAW_FRAMEBUFFER&&(u[s.FRAMEBUFFER]=se),L===s.FRAMEBUFFER&&(u[s.DRAW_FRAMEBUFFER]=se),!0):!1}function ye(L,se){let oe=p,xe=!1;if(L){oe=d.get(se),oe===void 0&&(oe=[],d.set(se,oe));const te=L.textures;if(oe.length!==te.length||oe[0]!==s.COLOR_ATTACHMENT0){for(let q=0,Se=te.length;q<Se;q++)oe[q]=s.COLOR_ATTACHMENT0+q;oe.length=te.length,xe=!0}}else oe[0]!==s.BACK&&(oe[0]=s.BACK,xe=!0);xe&&s.drawBuffers(oe)}function He(L){return g!==L?(s.useProgram(L),g=L,!0):!1}const at={[ei]:s.FUNC_ADD,[Wc]:s.FUNC_SUBTRACT,[Xc]:s.FUNC_REVERSE_SUBTRACT};at[Yc]=s.MIN,at[qc]=s.MAX;const A={[jc]:s.ZERO,[$c]:s.ONE,[Kc]:s.SRC_COLOR,[jr]:s.SRC_ALPHA,[nh]:s.SRC_ALPHA_SATURATE,[eh]:s.DST_COLOR,[Jc]:s.DST_ALPHA,[Zc]:s.ONE_MINUS_SRC_COLOR,[$r]:s.ONE_MINUS_SRC_ALPHA,[th]:s.ONE_MINUS_DST_COLOR,[Qc]:s.ONE_MINUS_DST_ALPHA,[ih]:s.CONSTANT_COLOR,[sh]:s.ONE_MINUS_CONSTANT_COLOR,[rh]:s.CONSTANT_ALPHA,[ah]:s.ONE_MINUS_CONSTANT_ALPHA};function $e(L,se,oe,xe,te,q,Se,Ne,ot,Qe){if(L===zn){x===!0&&(me(s.BLEND),x=!1);return}if(x===!1&&(K(s.BLEND),x=!0),L!==Gc){if(L!==m||Qe!==S){if((f!==ei||y!==ei)&&(s.blendEquation(s.FUNC_ADD),f=ei,y=ei),Qe)switch(L){case Ai:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case So:s.blendFunc(s.ONE,s.ONE);break;case Eo:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case bo:s.blendFuncSeparate(s.DST_COLOR,s.ONE_MINUS_SRC_ALPHA,s.ZERO,s.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}else switch(L){case Ai:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case So:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE,s.ONE,s.ONE);break;case Eo:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case bo:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}T=null,b=null,w=null,C=null,R.set(0,0,0),F=0,m=L,S=Qe}return}te=te||se,q=q||oe,Se=Se||xe,(se!==f||te!==y)&&(s.blendEquationSeparate(at[se],at[te]),f=se,y=te),(oe!==T||xe!==b||q!==w||Se!==C)&&(s.blendFuncSeparate(A[oe],A[xe],A[q],A[Se]),T=oe,b=xe,w=q,C=Se),(Ne.equals(R)===!1||ot!==F)&&(s.blendColor(Ne.r,Ne.g,Ne.b,ot),R.copy(Ne),F=ot),m=L,S=!1}function De(L,se){L.side===Nt?me(s.CULL_FACE):K(s.CULL_FACE);let oe=L.side===Ft;se&&(oe=!oe),be(oe),L.blending===Ai&&L.transparent===!1?$e(zn):$e(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),a.setFunc(L.depthFunc),a.setTest(L.depthTest),a.setMask(L.depthWrite),r.setMask(L.colorWrite);const xe=L.stencilWrite;o.setTest(xe),xe&&(o.setMask(L.stencilWriteMask),o.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),o.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),ge(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?K(s.SAMPLE_ALPHA_TO_COVERAGE):me(s.SAMPLE_ALPHA_TO_COVERAGE)}function be(L){M!==L&&(L?s.frontFace(s.CW):s.frontFace(s.CCW),M=L)}function ve(L){L!==zc?(K(s.CULL_FACE),L!==P&&(L===yo?s.cullFace(s.BACK):L===Hc?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):me(s.CULL_FACE),P=L}function Xe(L){L!==k&&(Y&&s.lineWidth(L),k=L)}function ge(L,se,oe){L?(K(s.POLYGON_OFFSET_FILL),(G!==se||j!==oe)&&(s.polygonOffset(se,oe),G=se,j=oe)):me(s.POLYGON_OFFSET_FILL)}function Ue(L){L?K(s.SCISSOR_TEST):me(s.SCISSOR_TEST)}function ct(L){L===void 0&&(L=s.TEXTURE0+X-1),le!==L&&(s.activeTexture(L),le=L)}function Ke(L,se,oe){oe===void 0&&(le===null?oe=s.TEXTURE0+X-1:oe=le);let xe=pe[oe];xe===void 0&&(xe={type:void 0,texture:void 0},pe[oe]=xe),(xe.type!==L||xe.texture!==se)&&(le!==oe&&(s.activeTexture(oe),le=oe),s.bindTexture(L,se||W[L]),xe.type=L,xe.texture=se)}function E(){const L=pe[le];L!==void 0&&L.type!==void 0&&(s.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function _(){try{s.compressedTexImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function N(){try{s.compressedTexImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function H(){try{s.texSubImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function J(){try{s.texSubImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function V(){try{s.compressedTexSubImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Q(){try{s.compressedTexSubImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ee(){try{s.texStorage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ue(){try{s.texStorage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function de(){try{s.texImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Z(){try{s.texImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ie(L){qe.equals(L)===!1&&(s.scissor(L.x,L.y,L.z,L.w),qe.copy(L))}function ce(L){Je.equals(L)===!1&&(s.viewport(L.x,L.y,L.z,L.w),Je.copy(L))}function re(L,se){let oe=l.get(se);oe===void 0&&(oe=new WeakMap,l.set(se,oe));let xe=oe.get(L);xe===void 0&&(xe=s.getUniformBlockIndex(se,L.name),oe.set(L,xe))}function ae(L,se){const xe=l.get(se).get(L);c.get(se)!==xe&&(s.uniformBlockBinding(se,xe,L.__bindingPointIndex),c.set(se,xe))}function Te(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),a.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),h={},le=null,pe={},u={},d=new WeakMap,p=[],g=null,x=!1,m=null,f=null,T=null,b=null,y=null,w=null,C=null,R=new we(0,0,0),F=0,S=!1,M=null,P=null,k=null,G=null,j=null,qe.set(0,0,s.canvas.width,s.canvas.height),Je.set(0,0,s.canvas.width,s.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:K,disable:me,bindFramebuffer:Ce,drawBuffers:ye,useProgram:He,setBlending:$e,setMaterial:De,setFlipSided:be,setCullFace:ve,setLineWidth:Xe,setPolygonOffset:ge,setScissorTest:Ue,activeTexture:ct,bindTexture:Ke,unbindTexture:E,compressedTexImage2D:_,compressedTexImage3D:N,texImage2D:de,texImage3D:Z,updateUBOMapping:re,uniformBlockBinding:ae,texStorage2D:ee,texStorage3D:ue,texSubImage2D:H,texSubImage3D:J,compressedTexSubImage2D:V,compressedTexSubImage3D:Q,scissor:ie,viewport:ce,reset:Te}}function Fg(s,e,t,n,i,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Le,h=new WeakMap;let u;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(E,_){return p?new OffscreenCanvas(E,_):hs("canvas")}function x(E,_,N){let H=1;const J=Ke(E);if((J.width>N||J.height>N)&&(H=N/Math.max(J.width,J.height)),H<1)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap||typeof VideoFrame<"u"&&E instanceof VideoFrame){const V=Math.floor(H*J.width),Q=Math.floor(H*J.height);u===void 0&&(u=g(V,Q));const ee=_?g(V,Q):u;return ee.width=V,ee.height=Q,ee.getContext("2d").drawImage(E,0,0,V,Q),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+V+"x"+Q+")."),ee}else return"data"in E&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),E;return E}function m(E){return E.generateMipmaps}function f(E){s.generateMipmap(E)}function T(E){return E.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:E.isWebGL3DRenderTarget?s.TEXTURE_3D:E.isWebGLArrayRenderTarget||E.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function b(E,_,N,H,J=!1){if(E!==null){if(s[E]!==void 0)return s[E];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let V=_;if(_===s.RED&&(N===s.FLOAT&&(V=s.R32F),N===s.HALF_FLOAT&&(V=s.R16F),N===s.UNSIGNED_BYTE&&(V=s.R8)),_===s.RED_INTEGER&&(N===s.UNSIGNED_BYTE&&(V=s.R8UI),N===s.UNSIGNED_SHORT&&(V=s.R16UI),N===s.UNSIGNED_INT&&(V=s.R32UI),N===s.BYTE&&(V=s.R8I),N===s.SHORT&&(V=s.R16I),N===s.INT&&(V=s.R32I)),_===s.RG&&(N===s.FLOAT&&(V=s.RG32F),N===s.HALF_FLOAT&&(V=s.RG16F),N===s.UNSIGNED_BYTE&&(V=s.RG8)),_===s.RG_INTEGER&&(N===s.UNSIGNED_BYTE&&(V=s.RG8UI),N===s.UNSIGNED_SHORT&&(V=s.RG16UI),N===s.UNSIGNED_INT&&(V=s.RG32UI),N===s.BYTE&&(V=s.RG8I),N===s.SHORT&&(V=s.RG16I),N===s.INT&&(V=s.RG32I)),_===s.RGB_INTEGER&&(N===s.UNSIGNED_BYTE&&(V=s.RGB8UI),N===s.UNSIGNED_SHORT&&(V=s.RGB16UI),N===s.UNSIGNED_INT&&(V=s.RGB32UI),N===s.BYTE&&(V=s.RGB8I),N===s.SHORT&&(V=s.RGB16I),N===s.INT&&(V=s.RGB32I)),_===s.RGBA_INTEGER&&(N===s.UNSIGNED_BYTE&&(V=s.RGBA8UI),N===s.UNSIGNED_SHORT&&(V=s.RGBA16UI),N===s.UNSIGNED_INT&&(V=s.RGBA32UI),N===s.BYTE&&(V=s.RGBA8I),N===s.SHORT&&(V=s.RGBA16I),N===s.INT&&(V=s.RGBA32I)),_===s.RGB&&(N===s.UNSIGNED_INT_5_9_9_9_REV&&(V=s.RGB9_E5),N===s.UNSIGNED_INT_10F_11F_11F_REV&&(V=s.R11F_G11F_B10F)),_===s.RGBA){const Q=J?tr:Ye.getTransfer(H);N===s.FLOAT&&(V=s.RGBA32F),N===s.HALF_FLOAT&&(V=s.RGBA16F),N===s.UNSIGNED_BYTE&&(V=Q===it?s.SRGB8_ALPHA8:s.RGBA8),N===s.UNSIGNED_SHORT_4_4_4_4&&(V=s.RGBA4),N===s.UNSIGNED_SHORT_5_5_5_1&&(V=s.RGB5_A1)}return(V===s.R16F||V===s.R32F||V===s.RG16F||V===s.RG32F||V===s.RGBA16F||V===s.RGBA32F)&&e.get("EXT_color_buffer_float"),V}function y(E,_){let N;return E?_===null||_===ni||_===ss?N=s.DEPTH24_STENCIL8:_===Jt?N=s.DEPTH32F_STENCIL8:_===is&&(N=s.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===ni||_===ss?N=s.DEPTH_COMPONENT24:_===Jt?N=s.DEPTH_COMPONENT32F:_===is&&(N=s.DEPTH_COMPONENT16),N}function w(E,_){return m(E)===!0||E.isFramebufferTexture&&E.minFilter!==At&&E.minFilter!==Ht?Math.log2(Math.max(_.width,_.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?_.mipmaps.length:1}function C(E){const _=E.target;_.removeEventListener("dispose",C),F(_),_.isVideoTexture&&h.delete(_)}function R(E){const _=E.target;_.removeEventListener("dispose",R),M(_)}function F(E){const _=n.get(E);if(_.__webglInit===void 0)return;const N=E.source,H=d.get(N);if(H){const J=H[_.__cacheKey];J.usedTimes--,J.usedTimes===0&&S(E),Object.keys(H).length===0&&d.delete(N)}n.remove(E)}function S(E){const _=n.get(E);s.deleteTexture(_.__webglTexture);const N=E.source,H=d.get(N);delete H[_.__cacheKey],a.memory.textures--}function M(E){const _=n.get(E);if(E.depthTexture&&(E.depthTexture.dispose(),n.remove(E.depthTexture)),E.isWebGLCubeRenderTarget)for(let H=0;H<6;H++){if(Array.isArray(_.__webglFramebuffer[H]))for(let J=0;J<_.__webglFramebuffer[H].length;J++)s.deleteFramebuffer(_.__webglFramebuffer[H][J]);else s.deleteFramebuffer(_.__webglFramebuffer[H]);_.__webglDepthbuffer&&s.deleteRenderbuffer(_.__webglDepthbuffer[H])}else{if(Array.isArray(_.__webglFramebuffer))for(let H=0;H<_.__webglFramebuffer.length;H++)s.deleteFramebuffer(_.__webglFramebuffer[H]);else s.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&s.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&s.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let H=0;H<_.__webglColorRenderbuffer.length;H++)_.__webglColorRenderbuffer[H]&&s.deleteRenderbuffer(_.__webglColorRenderbuffer[H]);_.__webglDepthRenderbuffer&&s.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const N=E.textures;for(let H=0,J=N.length;H<J;H++){const V=n.get(N[H]);V.__webglTexture&&(s.deleteTexture(V.__webglTexture),a.memory.textures--),n.remove(N[H])}n.remove(E)}let P=0;function k(){P=0}function G(){const E=P;return E>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+i.maxTextures),P+=1,E}function j(E){const _=[];return _.push(E.wrapS),_.push(E.wrapT),_.push(E.wrapR||0),_.push(E.magFilter),_.push(E.minFilter),_.push(E.anisotropy),_.push(E.internalFormat),_.push(E.format),_.push(E.type),_.push(E.generateMipmaps),_.push(E.premultiplyAlpha),_.push(E.flipY),_.push(E.unpackAlignment),_.push(E.colorSpace),_.join()}function X(E,_){const N=n.get(E);if(E.isVideoTexture&&Ue(E),E.isRenderTargetTexture===!1&&E.isExternalTexture!==!0&&E.version>0&&N.__version!==E.version){const H=E.image;if(H===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(H.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{W(N,E,_);return}}else E.isExternalTexture&&(N.__webglTexture=E.sourceTexture?E.sourceTexture:null);t.bindTexture(s.TEXTURE_2D,N.__webglTexture,s.TEXTURE0+_)}function Y(E,_){const N=n.get(E);if(E.isRenderTargetTexture===!1&&E.version>0&&N.__version!==E.version){W(N,E,_);return}t.bindTexture(s.TEXTURE_2D_ARRAY,N.__webglTexture,s.TEXTURE0+_)}function $(E,_){const N=n.get(E);if(E.isRenderTargetTexture===!1&&E.version>0&&N.__version!==E.version){W(N,E,_);return}t.bindTexture(s.TEXTURE_3D,N.__webglTexture,s.TEXTURE0+_)}function z(E,_){const N=n.get(E);if(E.version>0&&N.__version!==E.version){K(N,E,_);return}t.bindTexture(s.TEXTURE_CUBE_MAP,N.__webglTexture,s.TEXTURE0+_)}const le={[Vn]:s.REPEAT,[kn]:s.CLAMP_TO_EDGE,[er]:s.MIRRORED_REPEAT},pe={[At]:s.NEAREST,[Kl]:s.NEAREST_MIPMAP_NEAREST,[Ji]:s.NEAREST_MIPMAP_LINEAR,[Ht]:s.LINEAR,[js]:s.LINEAR_MIPMAP_NEAREST,[bn]:s.LINEAR_MIPMAP_LINEAR},Ee={[Sh]:s.NEVER,[Rh]:s.ALWAYS,[Eh]:s.LESS,[rc]:s.LEQUAL,[bh]:s.EQUAL,[wh]:s.GEQUAL,[Th]:s.GREATER,[Ah]:s.NOTEQUAL};function Oe(E,_){if(_.type===Jt&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===Ht||_.magFilter===js||_.magFilter===Ji||_.magFilter===bn||_.minFilter===Ht||_.minFilter===js||_.minFilter===Ji||_.minFilter===bn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(E,s.TEXTURE_WRAP_S,le[_.wrapS]),s.texParameteri(E,s.TEXTURE_WRAP_T,le[_.wrapT]),(E===s.TEXTURE_3D||E===s.TEXTURE_2D_ARRAY)&&s.texParameteri(E,s.TEXTURE_WRAP_R,le[_.wrapR]),s.texParameteri(E,s.TEXTURE_MAG_FILTER,pe[_.magFilter]),s.texParameteri(E,s.TEXTURE_MIN_FILTER,pe[_.minFilter]),_.compareFunction&&(s.texParameteri(E,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(E,s.TEXTURE_COMPARE_FUNC,Ee[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===At||_.minFilter!==Ji&&_.minFilter!==bn||_.type===Jt&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const N=e.get("EXT_texture_filter_anisotropic");s.texParameterf(E,N.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,i.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function qe(E,_){let N=!1;E.__webglInit===void 0&&(E.__webglInit=!0,_.addEventListener("dispose",C));const H=_.source;let J=d.get(H);J===void 0&&(J={},d.set(H,J));const V=j(_);if(V!==E.__cacheKey){J[V]===void 0&&(J[V]={texture:s.createTexture(),usedTimes:0},a.memory.textures++,N=!0),J[V].usedTimes++;const Q=J[E.__cacheKey];Q!==void 0&&(J[E.__cacheKey].usedTimes--,Q.usedTimes===0&&S(_)),E.__cacheKey=V,E.__webglTexture=J[V].texture}return N}function Je(E,_,N){return Math.floor(Math.floor(E/N)/_)}function We(E,_,N,H){const V=E.updateRanges;if(V.length===0)t.texSubImage2D(s.TEXTURE_2D,0,0,0,_.width,_.height,N,H,_.data);else{V.sort((Z,ie)=>Z.start-ie.start);let Q=0;for(let Z=1;Z<V.length;Z++){const ie=V[Q],ce=V[Z],re=ie.start+ie.count,ae=Je(ce.start,_.width,4),Te=Je(ie.start,_.width,4);ce.start<=re+1&&ae===Te&&Je(ce.start+ce.count-1,_.width,4)===ae?ie.count=Math.max(ie.count,ce.start+ce.count-ie.start):(++Q,V[Q]=ce)}V.length=Q+1;const ee=s.getParameter(s.UNPACK_ROW_LENGTH),ue=s.getParameter(s.UNPACK_SKIP_PIXELS),de=s.getParameter(s.UNPACK_SKIP_ROWS);s.pixelStorei(s.UNPACK_ROW_LENGTH,_.width);for(let Z=0,ie=V.length;Z<ie;Z++){const ce=V[Z],re=Math.floor(ce.start/4),ae=Math.ceil(ce.count/4),Te=re%_.width,L=Math.floor(re/_.width),se=ae,oe=1;s.pixelStorei(s.UNPACK_SKIP_PIXELS,Te),s.pixelStorei(s.UNPACK_SKIP_ROWS,L),t.texSubImage2D(s.TEXTURE_2D,0,Te,L,se,oe,N,H,_.data)}E.clearUpdateRanges(),s.pixelStorei(s.UNPACK_ROW_LENGTH,ee),s.pixelStorei(s.UNPACK_SKIP_PIXELS,ue),s.pixelStorei(s.UNPACK_SKIP_ROWS,de)}}function W(E,_,N){let H=s.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(H=s.TEXTURE_2D_ARRAY),_.isData3DTexture&&(H=s.TEXTURE_3D);const J=qe(E,_),V=_.source;t.bindTexture(H,E.__webglTexture,s.TEXTURE0+N);const Q=n.get(V);if(V.version!==Q.__version||J===!0){t.activeTexture(s.TEXTURE0+N);const ee=Ye.getPrimaries(Ye.workingColorSpace),ue=_.colorSpace===Bn?null:Ye.getPrimaries(_.colorSpace),de=_.colorSpace===Bn||ee===ue?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,_.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,_.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,de);let Z=x(_.image,!1,i.maxTextureSize);Z=ct(_,Z);const ie=r.convert(_.format,_.colorSpace),ce=r.convert(_.type);let re=b(_.internalFormat,ie,ce,_.colorSpace,_.isVideoTexture);Oe(H,_);let ae;const Te=_.mipmaps,L=_.isVideoTexture!==!0,se=Q.__version===void 0||J===!0,oe=V.dataReady,xe=w(_,Z);if(_.isDepthTexture)re=y(_.format===as,_.type),se&&(L?t.texStorage2D(s.TEXTURE_2D,1,re,Z.width,Z.height):t.texImage2D(s.TEXTURE_2D,0,re,Z.width,Z.height,0,ie,ce,null));else if(_.isDataTexture)if(Te.length>0){L&&se&&t.texStorage2D(s.TEXTURE_2D,xe,re,Te[0].width,Te[0].height);for(let te=0,q=Te.length;te<q;te++)ae=Te[te],L?oe&&t.texSubImage2D(s.TEXTURE_2D,te,0,0,ae.width,ae.height,ie,ce,ae.data):t.texImage2D(s.TEXTURE_2D,te,re,ae.width,ae.height,0,ie,ce,ae.data);_.generateMipmaps=!1}else L?(se&&t.texStorage2D(s.TEXTURE_2D,xe,re,Z.width,Z.height),oe&&We(_,Z,ie,ce)):t.texImage2D(s.TEXTURE_2D,0,re,Z.width,Z.height,0,ie,ce,Z.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){L&&se&&t.texStorage3D(s.TEXTURE_2D_ARRAY,xe,re,Te[0].width,Te[0].height,Z.depth);for(let te=0,q=Te.length;te<q;te++)if(ae=Te[te],_.format!==Yt)if(ie!==null)if(L){if(oe)if(_.layerUpdates.size>0){const Se=pl(ae.width,ae.height,_.format,_.type);for(const Ne of _.layerUpdates){const ot=ae.data.subarray(Ne*Se/ae.data.BYTES_PER_ELEMENT,(Ne+1)*Se/ae.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,te,0,0,Ne,ae.width,ae.height,1,ie,ot)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,te,0,0,0,ae.width,ae.height,Z.depth,ie,ae.data)}else t.compressedTexImage3D(s.TEXTURE_2D_ARRAY,te,re,ae.width,ae.height,Z.depth,0,ae.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else L?oe&&t.texSubImage3D(s.TEXTURE_2D_ARRAY,te,0,0,0,ae.width,ae.height,Z.depth,ie,ce,ae.data):t.texImage3D(s.TEXTURE_2D_ARRAY,te,re,ae.width,ae.height,Z.depth,0,ie,ce,ae.data)}else{L&&se&&t.texStorage2D(s.TEXTURE_2D,xe,re,Te[0].width,Te[0].height);for(let te=0,q=Te.length;te<q;te++)ae=Te[te],_.format!==Yt?ie!==null?L?oe&&t.compressedTexSubImage2D(s.TEXTURE_2D,te,0,0,ae.width,ae.height,ie,ae.data):t.compressedTexImage2D(s.TEXTURE_2D,te,re,ae.width,ae.height,0,ae.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):L?oe&&t.texSubImage2D(s.TEXTURE_2D,te,0,0,ae.width,ae.height,ie,ce,ae.data):t.texImage2D(s.TEXTURE_2D,te,re,ae.width,ae.height,0,ie,ce,ae.data)}else if(_.isDataArrayTexture)if(L){if(se&&t.texStorage3D(s.TEXTURE_2D_ARRAY,xe,re,Z.width,Z.height,Z.depth),oe)if(_.layerUpdates.size>0){const te=pl(Z.width,Z.height,_.format,_.type);for(const q of _.layerUpdates){const Se=Z.data.subarray(q*te/Z.data.BYTES_PER_ELEMENT,(q+1)*te/Z.data.BYTES_PER_ELEMENT);t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,q,Z.width,Z.height,1,ie,ce,Se)}_.clearLayerUpdates()}else t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,Z.width,Z.height,Z.depth,ie,ce,Z.data)}else t.texImage3D(s.TEXTURE_2D_ARRAY,0,re,Z.width,Z.height,Z.depth,0,ie,ce,Z.data);else if(_.isData3DTexture)L?(se&&t.texStorage3D(s.TEXTURE_3D,xe,re,Z.width,Z.height,Z.depth),oe&&t.texSubImage3D(s.TEXTURE_3D,0,0,0,0,Z.width,Z.height,Z.depth,ie,ce,Z.data)):t.texImage3D(s.TEXTURE_3D,0,re,Z.width,Z.height,Z.depth,0,ie,ce,Z.data);else if(_.isFramebufferTexture){if(se)if(L)t.texStorage2D(s.TEXTURE_2D,xe,re,Z.width,Z.height);else{let te=Z.width,q=Z.height;for(let Se=0;Se<xe;Se++)t.texImage2D(s.TEXTURE_2D,Se,re,te,q,0,ie,ce,null),te>>=1,q>>=1}}else if(Te.length>0){if(L&&se){const te=Ke(Te[0]);t.texStorage2D(s.TEXTURE_2D,xe,re,te.width,te.height)}for(let te=0,q=Te.length;te<q;te++)ae=Te[te],L?oe&&t.texSubImage2D(s.TEXTURE_2D,te,0,0,ie,ce,ae):t.texImage2D(s.TEXTURE_2D,te,re,ie,ce,ae);_.generateMipmaps=!1}else if(L){if(se){const te=Ke(Z);t.texStorage2D(s.TEXTURE_2D,xe,re,te.width,te.height)}oe&&t.texSubImage2D(s.TEXTURE_2D,0,0,0,ie,ce,Z)}else t.texImage2D(s.TEXTURE_2D,0,re,ie,ce,Z);m(_)&&f(H),Q.__version=V.version,_.onUpdate&&_.onUpdate(_)}E.__version=_.version}function K(E,_,N){if(_.image.length!==6)return;const H=qe(E,_),J=_.source;t.bindTexture(s.TEXTURE_CUBE_MAP,E.__webglTexture,s.TEXTURE0+N);const V=n.get(J);if(J.version!==V.__version||H===!0){t.activeTexture(s.TEXTURE0+N);const Q=Ye.getPrimaries(Ye.workingColorSpace),ee=_.colorSpace===Bn?null:Ye.getPrimaries(_.colorSpace),ue=_.colorSpace===Bn||Q===ee?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,_.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,_.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,ue);const de=_.isCompressedTexture||_.image[0].isCompressedTexture,Z=_.image[0]&&_.image[0].isDataTexture,ie=[];for(let q=0;q<6;q++)!de&&!Z?ie[q]=x(_.image[q],!0,i.maxCubemapSize):ie[q]=Z?_.image[q].image:_.image[q],ie[q]=ct(_,ie[q]);const ce=ie[0],re=r.convert(_.format,_.colorSpace),ae=r.convert(_.type),Te=b(_.internalFormat,re,ae,_.colorSpace),L=_.isVideoTexture!==!0,se=V.__version===void 0||H===!0,oe=J.dataReady;let xe=w(_,ce);Oe(s.TEXTURE_CUBE_MAP,_);let te;if(de){L&&se&&t.texStorage2D(s.TEXTURE_CUBE_MAP,xe,Te,ce.width,ce.height);for(let q=0;q<6;q++){te=ie[q].mipmaps;for(let Se=0;Se<te.length;Se++){const Ne=te[Se];_.format!==Yt?re!==null?L?oe&&t.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+q,Se,0,0,Ne.width,Ne.height,re,Ne.data):t.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+q,Se,Te,Ne.width,Ne.height,0,Ne.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):L?oe&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+q,Se,0,0,Ne.width,Ne.height,re,ae,Ne.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+q,Se,Te,Ne.width,Ne.height,0,re,ae,Ne.data)}}}else{if(te=_.mipmaps,L&&se){te.length>0&&xe++;const q=Ke(ie[0]);t.texStorage2D(s.TEXTURE_CUBE_MAP,xe,Te,q.width,q.height)}for(let q=0;q<6;q++)if(Z){L?oe&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,0,0,ie[q].width,ie[q].height,re,ae,ie[q].data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,Te,ie[q].width,ie[q].height,0,re,ae,ie[q].data);for(let Se=0;Se<te.length;Se++){const ot=te[Se].image[q].image;L?oe&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+q,Se+1,0,0,ot.width,ot.height,re,ae,ot.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+q,Se+1,Te,ot.width,ot.height,0,re,ae,ot.data)}}else{L?oe&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,0,0,re,ae,ie[q]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,Te,re,ae,ie[q]);for(let Se=0;Se<te.length;Se++){const Ne=te[Se];L?oe&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+q,Se+1,0,0,re,ae,Ne.image[q]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+q,Se+1,Te,re,ae,Ne.image[q])}}}m(_)&&f(s.TEXTURE_CUBE_MAP),V.__version=J.version,_.onUpdate&&_.onUpdate(_)}E.__version=_.version}function me(E,_,N,H,J,V){const Q=r.convert(N.format,N.colorSpace),ee=r.convert(N.type),ue=b(N.internalFormat,Q,ee,N.colorSpace),de=n.get(_),Z=n.get(N);if(Z.__renderTarget=_,!de.__hasExternalTextures){const ie=Math.max(1,_.width>>V),ce=Math.max(1,_.height>>V);J===s.TEXTURE_3D||J===s.TEXTURE_2D_ARRAY?t.texImage3D(J,V,ue,ie,ce,_.depth,0,Q,ee,null):t.texImage2D(J,V,ue,ie,ce,0,Q,ee,null)}t.bindFramebuffer(s.FRAMEBUFFER,E),ge(_)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,H,J,Z.__webglTexture,0,Xe(_)):(J===s.TEXTURE_2D||J>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,H,J,Z.__webglTexture,V),t.bindFramebuffer(s.FRAMEBUFFER,null)}function Ce(E,_,N){if(s.bindRenderbuffer(s.RENDERBUFFER,E),_.depthBuffer){const H=_.depthTexture,J=H&&H.isDepthTexture?H.type:null,V=y(_.stencilBuffer,J),Q=_.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,ee=Xe(_);ge(_)?o.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,ee,V,_.width,_.height):N?s.renderbufferStorageMultisample(s.RENDERBUFFER,ee,V,_.width,_.height):s.renderbufferStorage(s.RENDERBUFFER,V,_.width,_.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,Q,s.RENDERBUFFER,E)}else{const H=_.textures;for(let J=0;J<H.length;J++){const V=H[J],Q=r.convert(V.format,V.colorSpace),ee=r.convert(V.type),ue=b(V.internalFormat,Q,ee,V.colorSpace),de=Xe(_);N&&ge(_)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,de,ue,_.width,_.height):ge(_)?o.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,de,ue,_.width,_.height):s.renderbufferStorage(s.RENDERBUFFER,ue,_.width,_.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function ye(E,_){if(_&&_.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(s.FRAMEBUFFER,E),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const H=n.get(_.depthTexture);H.__renderTarget=_,(!H.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),X(_.depthTexture,0);const J=H.__webglTexture,V=Xe(_);if(_.depthTexture.format===rs)ge(_)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,J,0,V):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,J,0);else if(_.depthTexture.format===as)ge(_)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,J,0,V):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,J,0);else throw new Error("Unknown depthTexture format")}function He(E){const _=n.get(E),N=E.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==E.depthTexture){const H=E.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),H){const J=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,H.removeEventListener("dispose",J)};H.addEventListener("dispose",J),_.__depthDisposeCallback=J}_.__boundDepthTexture=H}if(E.depthTexture&&!_.__autoAllocateDepthBuffer){if(N)throw new Error("target.depthTexture not supported in Cube render targets");const H=E.texture.mipmaps;H&&H.length>0?ye(_.__webglFramebuffer[0],E):ye(_.__webglFramebuffer,E)}else if(N){_.__webglDepthbuffer=[];for(let H=0;H<6;H++)if(t.bindFramebuffer(s.FRAMEBUFFER,_.__webglFramebuffer[H]),_.__webglDepthbuffer[H]===void 0)_.__webglDepthbuffer[H]=s.createRenderbuffer(),Ce(_.__webglDepthbuffer[H],E,!1);else{const J=E.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,V=_.__webglDepthbuffer[H];s.bindRenderbuffer(s.RENDERBUFFER,V),s.framebufferRenderbuffer(s.FRAMEBUFFER,J,s.RENDERBUFFER,V)}}else{const H=E.texture.mipmaps;if(H&&H.length>0?t.bindFramebuffer(s.FRAMEBUFFER,_.__webglFramebuffer[0]):t.bindFramebuffer(s.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=s.createRenderbuffer(),Ce(_.__webglDepthbuffer,E,!1);else{const J=E.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,V=_.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,V),s.framebufferRenderbuffer(s.FRAMEBUFFER,J,s.RENDERBUFFER,V)}}t.bindFramebuffer(s.FRAMEBUFFER,null)}function at(E,_,N){const H=n.get(E);_!==void 0&&me(H.__webglFramebuffer,E,E.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),N!==void 0&&He(E)}function A(E){const _=E.texture,N=n.get(E),H=n.get(_);E.addEventListener("dispose",R);const J=E.textures,V=E.isWebGLCubeRenderTarget===!0,Q=J.length>1;if(Q||(H.__webglTexture===void 0&&(H.__webglTexture=s.createTexture()),H.__version=_.version,a.memory.textures++),V){N.__webglFramebuffer=[];for(let ee=0;ee<6;ee++)if(_.mipmaps&&_.mipmaps.length>0){N.__webglFramebuffer[ee]=[];for(let ue=0;ue<_.mipmaps.length;ue++)N.__webglFramebuffer[ee][ue]=s.createFramebuffer()}else N.__webglFramebuffer[ee]=s.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){N.__webglFramebuffer=[];for(let ee=0;ee<_.mipmaps.length;ee++)N.__webglFramebuffer[ee]=s.createFramebuffer()}else N.__webglFramebuffer=s.createFramebuffer();if(Q)for(let ee=0,ue=J.length;ee<ue;ee++){const de=n.get(J[ee]);de.__webglTexture===void 0&&(de.__webglTexture=s.createTexture(),a.memory.textures++)}if(E.samples>0&&ge(E)===!1){N.__webglMultisampledFramebuffer=s.createFramebuffer(),N.__webglColorRenderbuffer=[],t.bindFramebuffer(s.FRAMEBUFFER,N.__webglMultisampledFramebuffer);for(let ee=0;ee<J.length;ee++){const ue=J[ee];N.__webglColorRenderbuffer[ee]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,N.__webglColorRenderbuffer[ee]);const de=r.convert(ue.format,ue.colorSpace),Z=r.convert(ue.type),ie=b(ue.internalFormat,de,Z,ue.colorSpace,E.isXRRenderTarget===!0),ce=Xe(E);s.renderbufferStorageMultisample(s.RENDERBUFFER,ce,ie,E.width,E.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+ee,s.RENDERBUFFER,N.__webglColorRenderbuffer[ee])}s.bindRenderbuffer(s.RENDERBUFFER,null),E.depthBuffer&&(N.__webglDepthRenderbuffer=s.createRenderbuffer(),Ce(N.__webglDepthRenderbuffer,E,!0)),t.bindFramebuffer(s.FRAMEBUFFER,null)}}if(V){t.bindTexture(s.TEXTURE_CUBE_MAP,H.__webglTexture),Oe(s.TEXTURE_CUBE_MAP,_);for(let ee=0;ee<6;ee++)if(_.mipmaps&&_.mipmaps.length>0)for(let ue=0;ue<_.mipmaps.length;ue++)me(N.__webglFramebuffer[ee][ue],E,_,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ue);else me(N.__webglFramebuffer[ee],E,_,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0);m(_)&&f(s.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Q){for(let ee=0,ue=J.length;ee<ue;ee++){const de=J[ee],Z=n.get(de);let ie=s.TEXTURE_2D;(E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(ie=E.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),t.bindTexture(ie,Z.__webglTexture),Oe(ie,de),me(N.__webglFramebuffer,E,de,s.COLOR_ATTACHMENT0+ee,ie,0),m(de)&&f(ie)}t.unbindTexture()}else{let ee=s.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(ee=E.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),t.bindTexture(ee,H.__webglTexture),Oe(ee,_),_.mipmaps&&_.mipmaps.length>0)for(let ue=0;ue<_.mipmaps.length;ue++)me(N.__webglFramebuffer[ue],E,_,s.COLOR_ATTACHMENT0,ee,ue);else me(N.__webglFramebuffer,E,_,s.COLOR_ATTACHMENT0,ee,0);m(_)&&f(ee),t.unbindTexture()}E.depthBuffer&&He(E)}function $e(E){const _=E.textures;for(let N=0,H=_.length;N<H;N++){const J=_[N];if(m(J)){const V=T(E),Q=n.get(J).__webglTexture;t.bindTexture(V,Q),f(V),t.unbindTexture()}}}const De=[],be=[];function ve(E){if(E.samples>0){if(ge(E)===!1){const _=E.textures,N=E.width,H=E.height;let J=s.COLOR_BUFFER_BIT;const V=E.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Q=n.get(E),ee=_.length>1;if(ee)for(let de=0;de<_.length;de++)t.bindFramebuffer(s.FRAMEBUFFER,Q.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+de,s.RENDERBUFFER,null),t.bindFramebuffer(s.FRAMEBUFFER,Q.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+de,s.TEXTURE_2D,null,0);t.bindFramebuffer(s.READ_FRAMEBUFFER,Q.__webglMultisampledFramebuffer);const ue=E.texture.mipmaps;ue&&ue.length>0?t.bindFramebuffer(s.DRAW_FRAMEBUFFER,Q.__webglFramebuffer[0]):t.bindFramebuffer(s.DRAW_FRAMEBUFFER,Q.__webglFramebuffer);for(let de=0;de<_.length;de++){if(E.resolveDepthBuffer&&(E.depthBuffer&&(J|=s.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&(J|=s.STENCIL_BUFFER_BIT)),ee){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,Q.__webglColorRenderbuffer[de]);const Z=n.get(_[de]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,Z,0)}s.blitFramebuffer(0,0,N,H,0,0,N,H,J,s.NEAREST),c===!0&&(De.length=0,be.length=0,De.push(s.COLOR_ATTACHMENT0+de),E.depthBuffer&&E.resolveDepthBuffer===!1&&(De.push(V),be.push(V),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,be)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,De))}if(t.bindFramebuffer(s.READ_FRAMEBUFFER,null),t.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),ee)for(let de=0;de<_.length;de++){t.bindFramebuffer(s.FRAMEBUFFER,Q.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+de,s.RENDERBUFFER,Q.__webglColorRenderbuffer[de]);const Z=n.get(_[de]).__webglTexture;t.bindFramebuffer(s.FRAMEBUFFER,Q.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+de,s.TEXTURE_2D,Z,0)}t.bindFramebuffer(s.DRAW_FRAMEBUFFER,Q.__webglMultisampledFramebuffer)}else if(E.depthBuffer&&E.resolveDepthBuffer===!1&&c){const _=E.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[_])}}}function Xe(E){return Math.min(i.maxSamples,E.samples)}function ge(E){const _=n.get(E);return E.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function Ue(E){const _=a.render.frame;h.get(E)!==_&&(h.set(E,_),E.update())}function ct(E,_){const N=E.colorSpace,H=E.format,J=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||N!==Dt&&N!==Bn&&(Ye.getTransfer(N)===it?(H!==Yt||J!==dn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",N)),_}function Ke(E){return typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement?(l.width=E.naturalWidth||E.width,l.height=E.naturalHeight||E.height):typeof VideoFrame<"u"&&E instanceof VideoFrame?(l.width=E.displayWidth,l.height=E.displayHeight):(l.width=E.width,l.height=E.height),l}this.allocateTextureUnit=G,this.resetTextureUnits=k,this.setTexture2D=X,this.setTexture2DArray=Y,this.setTexture3D=$,this.setTextureCube=z,this.rebindTextures=at,this.setupRenderTarget=A,this.updateRenderTargetMipmap=$e,this.updateMultisampleRenderTarget=ve,this.setupDepthRenderbuffer=He,this.setupFrameBufferTexture=me,this.useMultisampledRTT=ge}function Og(s,e){function t(n,i=Bn){let r;const a=Ye.getTransfer(i);if(n===dn)return s.UNSIGNED_BYTE;if(n===Wa)return s.UNSIGNED_SHORT_4_4_4_4;if(n===Xa)return s.UNSIGNED_SHORT_5_5_5_1;if(n===Ql)return s.UNSIGNED_INT_5_9_9_9_REV;if(n===ec)return s.UNSIGNED_INT_10F_11F_11F_REV;if(n===Zl)return s.BYTE;if(n===Jl)return s.SHORT;if(n===is)return s.UNSIGNED_SHORT;if(n===Ga)return s.INT;if(n===ni)return s.UNSIGNED_INT;if(n===Jt)return s.FLOAT;if(n===fs)return s.HALF_FLOAT;if(n===tc)return s.ALPHA;if(n===nc)return s.RGB;if(n===Yt)return s.RGBA;if(n===rs)return s.DEPTH_COMPONENT;if(n===as)return s.DEPTH_STENCIL;if(n===Ya)return s.RED;if(n===qa)return s.RED_INTEGER;if(n===ic)return s.RG;if(n===ja)return s.RG_INTEGER;if(n===$a)return s.RGBA_INTEGER;if(n===$s||n===Ks||n===Zs||n===Js)if(a===it)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===$s)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Ks)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Zs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Js)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===$s)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Ks)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Zs)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Js)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===ra||n===aa||n===oa||n===la)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===ra)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===aa)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===oa)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===la)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ca||n===ha||n===ua)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===ca||n===ha)return a===it?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===ua)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===da||n===fa||n===pa||n===ma||n===ga||n===_a||n===xa||n===va||n===Ma||n===ya||n===Sa||n===Ea||n===ba||n===Ta)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===da)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===fa)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===pa)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===ma)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ga)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===_a)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===xa)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===va)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ma)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===ya)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Sa)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Ea)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ba)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Ta)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Aa||n===wa||n===Ra)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Aa)return a===it?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===wa)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Ra)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Ca||n===Pa||n===La||n===Da)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Ca)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Pa)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===La)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Da)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===ss?s.UNSIGNED_INT_24_8:s[n]!==void 0?s[n]:null}return{convert:t}}const Bg=`
void main() {
 ...
 */class un{constructor(e,t,n,i,r="div"){this.parent=e,this.object=t,this.property=n,this._disabled=!1,this._hidden=!1,this.initialValue=this.getValue(),this.domElement=document.createElement("div"),this.domElement.classList.add("controller"),this.domElement.classList.add(i),this.$name=document.createElement("div"),this.$name.classList.add("name"),un.nextNameID=un.nextNameID||0,this.$name.id="lil-gui-name-"+ ++un.nextNameID,this.$widget=document.createElement(r),this.$widget.classList.add("widget"),this.$disable=this.$widget,this.domElement.appendChild(this.$name),this.domElement.appendChild(this.$widget),this.parent.children.push(this),this.parent.controllers.push(this),this.parent.$children.appendChild(this.domElement),this._listenCallback=this._listenCallback.bind(this),this.name(n)}name(e){return this._name=e,this.$name.innerHTML=e,this}onChange(e){return this._onChange=e,this}_callOnChange(){this.parent._callOnChange(this),this._onChange!==void 0&&this._onChange.call(this,this.getValue()),this._changed=!0}onFinishChange(e){return this._onFinishChange=e,this}_callOnFinishChange(){this._changed&&(this.parent._callOnFinishChange(this),this._onFinishChange!==void 0&&this._onFinishChange.call(this,this.getValue())),this._changed=!1}reset(){return this.setValue(this.initialValue),this._callOnFinishChange(),this}enable(e=!0){return this.disable(!e)}disable(e=!0){return e===this._disabled||(this._disabled=e,this.domElement.classList.toggle("disabled",e),this.$disable.toggleAttribute("disabled",e)),this}show(e=!0){return this._hidden=!e,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}options(e){const t=this.parent.add(this.object,this.property,e);return t.name(this._name),this.destroy(),t}min(e){return this}max(e){return this}step(e){return this}decimals(e){return this}listen(e=!0){return this._listening=e,this._listenCallbackID!==void 0&&(cancelAnimationFrame(this._listenCallbackID),this._listenCallbackID=void 0),this._listening&&this._listenCallback(),this}_listenCallback(){this._listenCallbackID=requestAnimationFrame(this._listenCallback);const e=this.save();e!==this._listenPrevValue&&this.updateDisplay(),this._listenPrevValue=e}getValue(){return this.object[this.property]}setValue(e){return this.object[this.property]=e,this._callOnChange(),this.updateDisplay(),this}updateDisplay(){return this}load(e){return this.setValue(e),this._callOnFinishChange(),this}save(){return this.getValue()}destroy(){this.listen(!1),this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.controllers.splice(this.parent.controllers.indexOf(this),1),this.parent.$children.removeChild(this.domElement)}}class H_ extends un{constructor(e,t,n){super(e,t,n,"boolean","label"),this.$input=document.createElement("input"),this.$input.setAttribute("type","checkbox"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$widget.appendChild(this.$input),this.$input.addEventListener("change",()=>{this.setValue(this.$input.checked),this._callOnFinishChange()}),this.$disable=this.$input,this.updateDisplay()}updateDisplay(){return this.$input.checked=this.getValue(),this}}function za(s){let e,t;return(e=s.match(/(#|0x)?([a-f0-9]{6})/i))?t=e[2]:(e=s.match(/rgb\(\s*(\d*)\s*,\s*(\d*)\s*,\s*(\d*)\s*\)/))?t=parseInt(e[1]).toString(16).padStart(2,0)+parseInt(e[2]).toString(16).padStart(2,0)+parseInt(e[3]).toString(16).padStart(2,0):(e=s.match(/^#?([a-f0-9])([a-f0-9])([a-f0-9])$/i))&&(t=e[1]+e[1]+e[2]+e[2]+e[3]+e[3]),!!t&&"#"+t}const V_={isPrimitive:!0,match:s=>typeof s=="string",fromHexString:za,toHexString:za},ds={isPrimitive:!0,match:s=>typeof s=="number",fromHexString:s=>parseInt(s.substring(1),16),toHexString:s=>"#"+s.toString(16).padStart(6,0)},G_={isPrimitive:!1,match:Array.isArray,fromHexString(s,e,t=1){const n=ds.fromHexString(s);e[0]=(n>>16&255)/255*t,e[1]=(n>>8&255)/255*t,e[2]=(255&n)/255*t},toHexString:([s,e,t],n=1)=>ds.toHexString(s*(n=255/n)<<16^e*n<<8^t*n<<0)},W_={isPrimitive:!1,match:s=>Object(s)===s,fromHexString(s,e,t=1){const n=ds.fromHexString(s);e.r=(n>>16&255)/255*t,e.g=(n>>8&255)/255*t,e.b=(255&n)/255*t},toHexString:({r:s,g:e,b:t},n=1)=>ds.toHexString(s*(n=255/n)<<16^e*n<<8^t*n<<0)},X_=[V_,ds,G_,W_];class Y_ extends un{constructor(e,t,n,i){var r;super(e,t,n,"color"),this.$input=document.createElement("input"),this.$input.setAttribute("type","color"),this.$input.setAttribute("tabindex",-1),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$text=document.createElement("input"),this.$text.setAttribute("type","text"),this.$text.setAttribute("spellcheck","false"),this.$text.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this.$display.appendChild(this.$input),this.$widget.appendChild(this.$display),this.$widget.appendChild(this.$text),this._format=(r=this.initialValue,X_.find(a=>a.match(r))),this._rgbScale=i,this._initialValueHexString=this.save(),this._textFocused=!1,this.$input.addEventListener("input",()=>{this._setValueFromHexString(this.$input.value)}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$text.addEventListener("input",()=>{const a=za(this.$text.value);a&&this._setValueFromHexString(a)}),this.$text.addEventListener("focus",()=>{this._textFocused=!0,this.$text.select()}),this.$text.addEventListener("blur",()=>{this._textFocused=!1,this.updateDisplay(),this._callOnFinishChange()}),this.$disable=this.$text,this.updateDisplay()}reset(){return this._setValueFromHexString(this._initialValueHexString),this}_setValueFromHexString(e){if(this._format.isPrimitive){const t=this._format.fromHexString(e);this.setValue(t)}else this._format.fromHexString(e,this.getValue(),this._rgbScale),this._callOnChange(),this.updateDisplay()}save(){return this._format.toHexString(this.getValue(),this._rgbScale)}load(e){return this._setValueFromHexString(e),this._callOnFinishChange(),this}updateDisplay(){return this.$input.value=this._format.toHexString(this.getValue(),this._rgbScale),this._textFocused||(this.$text.value=this.$input.value.substring(1)),this.$display.style.backgroundColor=this.$input.value,this}}class qr extends un{constructor(e,t,n){super(e,t,n,"function"),this.$button=document.createElement("button"),this.$button.appendChild(this.$name),this.$widget.appendChild(this.$button),this.$button.addEventListener("click",i=>{i.preventDefault(),this.getValue().call(this.object)}),this.$button.addEventListener("touchstart",()=>{},{passive:!0}),this.$disable=this.$button}}class q_ extends un{constructor(e,t,n,i,r,a){super(e,t,n,"number"),this._initInput(),this.min(i),this.max(r);const o=a!==void 0;this.step(o?a:this._getImplicitStep(),o),this.updateDisplay()}decimals(e){return this._decimals=e,this.updateDisplay(),this}min(e){return this._min=e,this._onUpdateMinMax(),this}max(e){return this._max=e,this._onUpdateMinMax(),this}step(e,t=!0){return this._step=e,this._stepExplicit=t,this}updateDisplay(){const e=this.getValue();if(this._hasSlider){let t=(e-this._min)/(this._max-this._min);t=Math.max(0,Math.min(t,1)),this.$fill.style.width=100*t+"%"}return this._inputFocused||(this.$input.value=this._decimals===void 0?e:e.toFixed(this._decimals)),this}_initInput(){this.$input=document.createElement("input"),this.$input.setAttribute("type","number"),this.$input.setAttribute("step","any"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$widget.appendChild(this.$input),this.$disable=this.$input;const e=h=>{const u=parseFloat(this.$input.value);isNaN(u)||(this._snapClampSetValue(u+h),this.$input.value=this.getValue())};let t,n,i,r,a,o=!1;const c=h=>{if(o){const u=h.clientX-t,d=h.clientY-n;Math.abs(d)>5?(h.preventDefault(),this.$input.blur(),o=!1,this._setDraggingStyle(!0,"vertical")):Math.abs(u)>5&&l()}if(!o){const u=h.clientY-i;a-=u*this._step*this._arrowKeyMultiplier(h),r+a>this._max?a=this._max-r:r+a<this._min&&(a=this._min-r),this._snapClampSetValue(r+a)}i=h.clientY},l=()=>{this._setDraggingStyle(!1,"vertical"),this._callOnFinishChange(),window.removeEventListener("mousemove",c),window.removeEventListener("mouseup",l)};this.$input.addEventListener("input",()=>{let h=parseFloat(this.$input.value);isNaN(h)||(this._stepExplicit&&(h=this._snap(h)),this.setValue(this._clamp(h)))}),this.$input.addEventListener("keydown",h=>{h.code==="Enter"&&this.$input.blur(),h.code==="ArrowUp"&&(h.preventDefault(),e(this._step*this._arrowKeyMultiplier(h))),h.code==="ArrowDown"&&(h.preventDefault(),e(this._step*this._arrowKeyMultiplier(h)*-1))}),this.$input.addEventListener("wheel",h=>{this._inputFocused&&(h.preventDefault(),e(this._step*this._normalizeMouseWheel(h)))},{passive:!1}),this.$input.addEventListener("mousedown",h=>{t=h.clientX,n=i=h.clientY,o=!0,r=this.getValue(),a=0,window.addEventListener("mousemove",c),window.addEventListener("mouseup",l)}),this.$input.addEventListener("focus",()=>{this._inputFocused=!0}),this.$input.addEventListener("blur",()=>{this._inputFocused=!1,this.updateDisplay(),this._callOnFinishChange()})}_initSlider(){this._hasSlider=!0,this.$slider=document.createElement("div"),this.$slider.classList.add("slider"),this.$fill=document.createElement("div"),this.$fill.classList.add("fill"),this.$slider.appendChild(this.$fill),this.$widget.insertBefore(this.$slider,this.$input),this.domElement.classList.add("hasSlider");const e=d=>{const p=this.$slider.getBoundingClientRect();let g=(x=d,m=p.left,f=p.right,T=this._min,b=this._max,(x-m)/(f-m)*(b-T)+T);var x,m,f,T,b;this._snapClampSetValue(g)},t=d=>{e(d.clientX)},n=()=>{this._callOnFinishChange(),this._setDraggingStyle(!1),window.removeEventListener("mousemove",t),window.removeEventListener("mouseup",n)};let i,r,a=!1;const o=d=>{d.preventDefault(),this._setDraggingStyle(!0),e(d.touches[0].clientX),a=!1},c=d=>{if(a){const p=d.touches[0].clientX-i,g=d.touches[0].clientY-r;Math.abs(p)>Math.abs(g)?o(d):(window.removeEventListener("touchmove",c),window.removeEventListener("touchend",l))}else d.preventDefault(),e(d.touches[0].clientX)},l=()=>{this._callOnFinishChange(),this._setDraggingStyle(!1),window.removeEventListener("touchmove",c),window.removeEventListener("touchend",l)},h=this._callOnFinishChange.bind(this);let u;this.$slider.addEventListener("mousedown",d=>{this._setDraggingStyle(!0),e(d.clientX),window.addEventListener("mousemove",t),window.addEventListener("mouseup",n)}),this.$slider.addEventListener("touchstart",d=>{d.touches.length>1||(this._hasScrollBar?(i=d.touches[0].clientX,r=d.touches[0].clientY,a=!0):o(d),window.addEventListener("touchmove",c,{passive:!1}),window.addEventListener("touchend",l))},{passive:!1}),this.$slider.addEventListener("wheel",d=>{if(Math.abs(d.deltaX)<Math.abs(d.deltaY)&&this._hasScrollBar)return;d.preventDefault();const p=this._normalizeMouseWheel(d)*this._step;this._snapClampSetValue(this.getValue()+p),this.$input.value=this.getValue(),clearTimeout(u),u=setTimeout(h,400)},{passive:!1})}_setDraggingStyle(e,t="horizontal"){this.$slider&&this.$slider.classList.toggle("active",e),document.body.classList.toggle("lil-gui-dragging",e),document.body.classList.toggle("lil-gui-"+t,e)}_getImplicitStep(){return this._hasMin&&this._hasMax?(this._max-this._min)/1e3:.1}_onUpdateMinMax(){!this._hasSlider&&this._hasMin&&this._hasMax&&(this._stepExplicit||this.step(this._getImplicitStep(),!1),this._initSlider(),this.updateDisplay())}_normalizeMouseWheel(e){let{deltaX:t,deltaY:n}=e;return Math.floor(e.deltaY)!==e.deltaY&&e.wheelDelta&&(t=0,n=-e.wheelDelta/120,n*=this._stepExplicit?1:10),t+-n}_arrowKeyMultiplier(e){let t=this._stepExplicit?1:10;return e.shiftKey?t*=10:e.altKey&&(t/=10),t}_snap(e){const t=Math.round(e/this._step)*this._step;return parseFloat(t.toPrecision(15))}_clamp(e){return e<this._min&&(e=this._min),e>this._max&&(e=this._max),e}_snapClampSetValue(e){this.setValue(this._clamp(this._snap(e)))}get _hasScrollBar(){const e=this.parent.root.$children;return e.scrollHeight>e.clientHeight}get _hasMin(){return this._min!==void 0}get _hasMax(){return this._max!==void 0}}class j_ extends un{constructor(e,t,n,i){super(e,t,n,"option"),this.$select=document.createElement("select"),this.$select.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this._values=Array.isArray(i)?i:Object.values(i),this._names=Array.isArray(i)?i:Object.keys(i),this._names.forEach(r=>{const a=document.createElement("option");a.innerHTML=r,this.$select.appendChild(a)}),this.$select.addEventListener("change",()=>{this.setValue(this._values[this.$select.selectedIndex]),this._callOnFinishChange()}),this.$select.addEventListener("focus",()=>{this.$display.classList.add("focus")}),this.$select.addEventListener("blur",()=>{this.$display.classList.remove("focus")}),this.$widget.appendChild(this.$select),this.$widget.appendChild(this.$display),this.$disable=this.$select,this.updateDisplay()}updateDisplay(){const e=this.getValue(),t=this._values.indexOf(e);return this.$select.selectedIndex=t,this.$display.innerHTML=t===-1?e:this._names[t],this}}class $_ extends un{constructor(e,t,n){super(e,t,n,"string"),this.$input=document.createElement("input"),this.$input.setAttribute("type","text"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$input.addEventListener("input",()=>{this.setValue(this.$input.value)}),this.$input.addEventListener("keydown",i=>{i.code==="Enter"&&this.$input.blur()}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$widget.appendChild(this.$input),this.$disable=this.$input,this.updateDisplay()}updateDisplay(){return this.$input.value=this.getValue(),this}}let Yl=!1;class po{constructor({parent:e,autoPlace:t=e===void 0,container:n,width:i,title:r="Controls",injectStyles:a=!0,touchStyles:o=!0}={}){if(this.parent=e,this.root=e?e.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement("div"),this.domElement.classList.add("lil-gui"),this.$title=document.createElement("div"),this.$title.classList.add("title"),this.$title.setAttribute("role","button"),this.$title.setAttribute("aria-expanded",!0),this.$title.setAttribute("tabindex",0),this.$title.addEventListener("click",()=>this.openAnimated(this._closed)),this.$title.addEventListener("keydown",c=>{c.code!=="Enter"&&c.code!=="Space"||(c.preventDefault(),this.$title.click())}),this.$title.addEventListener("touchstart",()=>{},{passive:!0}),this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(r),o&&this.domElement.classList.add("allow-touch-styles"),this.parent)return this.parent.children.push(this),this.parent.folders.push(this),void this.parent.$children.appendChild(this.domElement);this.domElement.classList.add("root"),!Yl&&a&&((function(c){const l=document.createElement("style");l.innerHTML=c;const h=document.querySelector("head link[rel=stylesheet], head style");h?document.head.insertBefore(l,h):document.head.appendChild(l)})('.lil-gui{--background-color:#1f1f1f;--text-color:#ebebeb;--title-background-color:#111;--title-text-color:#ebebeb;--widget-color:#424242;--hover-color:#4f4f4f;--focus-color:#595959;--number-color:#2cc9ff;--string-color:#a2db3c;--font-size:11px;--input-font-size:11px;--font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Arial,sans-serif;--font-family-mono:Menlo,Monaco,Consolas,"Droid Sans Mono",monospace;--padding:4px;--spacing:4px;--widget-height:20px;--name-width:45%;--slider-knob-width:2px;--slider-input-width:27%;--color-input-width:27%;--slider-input-min-width:45px;--color-input-min-width:45px;--folder-indent:7px;--widget-padding:0 0 0 3px;--widget-border-radius:2px;--checkbox-size:calc(var(--widget-height)*0.75);--scrollbar-width:5px;background-color:var(--background-color);color:var(--text-color);font-family:var(--font-family);font-size:var(--font-size);font-style:normal;font-weight:400;line-height:1;text-align:left;touch-action:manipulation;user-select:none;-webkit-user-select:none}.lil-gui,.lil-gui *{box-sizing:border-box;margin:0;padding:0}.lil-gui.root{display:flex;flex-direction:column;width:var(--width,245px)}.lil-gui.root>.title{background:var(--title-background-color);color:var(--title-text-color)}.lil-gui.root>.children{overflow-x:hidden;overflow-y:auto}.lil-gui.root>.children::-webkit-scrollbar{background:var(--background-color);height:var(--scrollbar-width);width:var(--scrollbar-width)}.lil-gui.root>.children::-webkit-scrollbar-thumb{background:var(--focus-color);border-radius:var(--scrollbar-width)}.lil-gui.force-touch-styles{--widget-height:28px;--padding:6px;--spacing:6px;--font-size:13px;--input-font-size:16px;--folder-indent:10px;--scrollbar-width:7px;--slider-input-min-width:50px;--color-input-min-width:65px}.lil-gui.autoPlace{max-height:100%;position:fixed;right:15px;top:0;z-index:1001}.lil-gui .controller{align-items:center;display:flex;margin:var(--spacing) 0;padding:0 var(--padding)}.lil-gui .controller.disabled{opacity:.5}.lil-gui .controller.disabled,.lil-gui .controller.disabled *{pointer-events:none!important}.lil-gui .controller>.name{flex-shrink:0;line-height:var(--widget-height);min-width:var(--name-width);padding-right:var(--spacing);white-space:pre}.lil-gui .controller .widget{align-items:center;display:flex;min-height:var(--widget-height);position:relative;width:100%}.lil-gui .controller.string input{color:var(--string-color)}.lil-gui .controller.boolean .widget{cursor:pointer}.lil-gui .controller.color .display{border-radius:var(--widget-border-radius);height:var(--widget-height);position:relative;width:100%}.lil-gui .controller.color input[type=color]{cursor:pointer;height:100%;opacity:0;width:100%}.lil-gui .controller.color input[type=text]{flex-shrink:0;font-family:var(--font-family-mono);margin-left:var(--spacing);min-width:var(--color-input-min-width);width:var(--color-input-width)}.lil-gui .controller.option select{max-width:100%;opacity:0;position:absolute;width:100%}.lil-gui .controller.option .display{background:var(--widget-color);border-radius:var(--widget-border-radius);height:var(--widget-height);line-height:var(--widget-height);max-width:100%;overflow:hidden;padding-left:.55em;padding-right:1.75em;pointer-events:none;position:relative;word-break:break-all}.lil-gui .controller.option .display.active{background:var(--focus-color)}.lil-gui .controller.option .display:after{bottom:0;content:"↕";font-family:lil-gui;padding-right:.375em;position:absolute;right:0;top:0}.lil-gui .controller.option .widget,.lil-gui .controller.option select{cursor:pointer}.lil-gui .controller.number input{color:var(--number-color)}.lil-gui .controller.number.hasSlider input{flex-shrink:0;margin-left:var(--spacing);min-width:var(--slider-input-min-width);width:var(--slider-input-width)}.lil-gui .controller.number .slider{background-color:var(--widget-color);border-radius:var(--widget-border-radius);cursor:ew-resize;height:var(--widget-height);overflow:hidden;padding-right:var(--slider-knob-width);touch-action:pan-y;width:100%}.lil-gui .controller.number .slider.active{background-color:var(--focus-color)}.lil-gui .controller.number .slider.active .fill{opacity:.95}.lil-gui .controller.number .fill{border-right:var(--slider-knob-width) solid var(--number-color);box-sizing:content-box;height:100%}.lil-gui-dragging .lil-gui{--hover-color:var(--widget-color)}.lil-gui-dragging *{cursor:ew-resize!important}.lil-gui-dragging.lil-gui-vertical *{cursor:ns-resize!important}.lil-gui .title{--title-height:calc(var(--widget-height) + var(--spacing)*1.25);-webkit-tap-highlight-color:transparent;text-decoration-skip:objects;cursor:pointer;font-weight:600;height:var(--title-height);line-height:calc(var(--title-height) - 4px);outline:none;padding:0 var(--padding)}.lil-gui .title:before{content:"▾";display:inline-block;font-family:lil-gui;padding-right:2px}.lil-gui .title:active{background:var(--title-background-color);opacity:.75}.lil-gui.root>.title:focus{text-decoration:none!important}.lil-gui.closed>.title:before{content:"▸"}.lil-gui.closed>.children{opacity:0;transform:translateY(-7px)}.lil-gui.closed:not(.transition)>.children{display:none}.lil-gui.transition>.children{overflow:hidden;pointer-events:none;transition-duration:.3s;transition-property:height,opacity,transform;transition-timing-function:cubic-bezier(.2,.6,.35,1)}.lil-gui .children:empty:before{content:"Empty";display:block;font-style:italic;height:var(--widget-height);line-height:var(--widget-height);margin:var(--spacing) 0;opacity:.5;padding:0 var(--padding)}.lil-gui.root>.children>.lil-gui>.title{border-width:0;border-bottom:1px solid var(--widget-color);border-left:0 solid var(--widget-color);border-right:0 solid var(--widget-color);border-top:1px solid var(--widget-color);transition:border-color .3s}.lil-gui.root>.children>.lil-gui.closed>.title{border-bottom-color:transparent}.lil-gui+.controller{border-top:1px solid var(--widget-color);margin-top:0;padding-top:var(--spacing)}.lil-gui .lil-gui .lil-gui>.title{border:none}.lil-gui .lil-gui .lil-gui>.children{border:none;border-left:2px solid var(--widget-color);margin-left:var(--folder-indent)}.lil-gui .lil-gui .controller{border:none}.lil-gui input{-webkit-tap-highlight-color:transparent;background:var(--widget-color);border:0;border-radius:var(--widget-border-radius);color:var(--text-color);font-family:var(--font-family);font-size:var(--input-font-size);height:var(--widget-height);outline:none;width:100%}.lil-gui input:disabled{opacity:1}.lil-gui input[type=number],.lil-gui input[type=text]{padding:var(--widget-padding)}.lil-gui input[type=number]:focus,.lil-gui input[type=text]:focus{background:var(--focus-color)}.lil-gui input::-webkit-inner-spin-button,.lil-gui input::-webkit-outer-spin-button{-webkit-appearance:none;margin:0}.lil-gui input[type=number]{-moz-appearance:textfield}.lil-gui input[type=checkbox]{appearance:none;-webkit-appearance:none;border-radius:var(--widget-border-radius);cursor:pointer;height:var(--checkbox-size);text-align:center;width:var(--checkbox-size)}.lil-gui input[type=checkbox]:checked:before{content:"✓";font-family:lil-gui;font-size:var(--checkbox-size);line-height:var(--checkbox-size)}.lil-gui button{-webkit-tap-highlight-color:transparent;background:var(--widget-color);border:1px solid var(--widget-color);border-radius:var(--widget-border-radius);color:var(--text-color);cursor:pointer;font-family:var(--font-family);font-size:var(--font-size);height:var(--widget-height);line-height:calc(var(--widget-height) - 4px);outline:none;text-align:center;text-transform:none;width:100%}.lil-gui button:active{background:var(--focus-color)}@font-face{font-family:lil-gui;src:url("data:application/font-woff;charset=utf-8;base64,") format("woff")}@media (pointer:coarse){.lil-gui.allow-touch-styles{--widget-height:28px;--padding:6px;--spacing:6px;--font-size:13px;--input-font-size:16px;--folder-indent:10px;--scrollbar-width:7px;--slider-input-min-width:50px;--color-input-min-width:65px}}@media (hover:hover){.lil-gui .controller.color .display:hover:before{border:1px solid #fff9;border-radius:var(--widget-border-radius);bottom:0;content:" ";display:block;left:0;position:absolute;right:0;top:0}.lil-gui .controller.option .display.focus{background:var(--focus-color)}.lil-gui .controller.option .widget:hover .display{background:var(--hover-color)}.lil-gui .controller.number .slider:hover{background-color:var(--hover-color)}body:not(.lil-gui-dragging) .lil-gui .title:hover{background:var(--title-background-color);opacity:.85}.lil-gui .title:focus{text-decoration:underline var(--focus-color)}.lil-gui input:hover{background:var(--hover-color)}.lil-gui input:active{background:var(--focus-color)}.lil-gui input[type=checkbox]:focus{box-shadow:inset 0 0 0 1px var(--focus-color)}.lil-gui button:hover{background:var(--hover-color);border-color:var(--hover-color)}.lil-gui button:focus{border-color:var(--focus-color)}}'),Yl=!0),n?n.appendChild(this.domElement):t&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),i&&this.domElement.style.setProperty("--width",i+"px"),this.domElement.addEventListener("keydown",c=>c.stopPropagation()),this.domElement.addEventListener("keyup",c=>c.stopPropagation())}add(e,t,n,i,r){if(Object(n)===n)return new j_(this,e,t,n);const a=e[t];switch(typeof a){case"number":return new q_(this,e,t,n,i,r);case"boolean":return new H_(this,e,t);case"string":return new $_(this,e,t);case"function":return new qr(this,e,t)}console.error(`gui.add failed
	property:`,t,`
	object:`,e,`
	value:`,a)}addColor(e,t,n=1){return new Y_(this,e,t,n)}addFolder(e){return new po({parent:this,title:e})}load(e,t=!0){return e.controllers&&this.controllers.forEach(n=>{n instanceof qr||n._name in e.controllers&&n.load(e.controllers[n._name])}),t&&e.folders&&this.folders.forEach(n=>{n._title in e.folders&&n.load(e.folders[n._title])}),this}save(e=!0){const t={controllers:{},folders:{}};return this.controllers.forEach(n=>{if(!(n instanceof qr)){if(n._name in t.controllers)throw new Error(`Cannot save GUI with duplicate property "${n._name}"`);t.controllers[n._name]=n.save()}}),e&&this.folders.forEach(n=>{if(n._title in t.folders)throw new Error(`Cannot save GUI with duplicate folder "${n._title}"`);t.folders[n._title]=n.save()}),t}open(e=!0){return this._closed=!e,this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}show(e=!0){return this._hidden=!e,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(e=!0){return this._closed=!e,this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const t=this.$children.clientHeight;this.$children.style.height=t+"px",this.domElement.classList.add("transition");const n=r=>{r.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",n))};this.$children.addEventListener("transitionend",n);const i=e?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!e),requestAnimationFrame(()=>{this.$children.style.height=i+"px"})}),this}title(e){return this._title=e,this.$title.innerHTML=e,this}reset(e=!0){return(e?this.controllersRecursive():this.controllers).forEach(t=>t.reset()),this}onChange(e){return this._onChange=e,this}_callOnChange(e){this.parent&&this.parent._callOnChange(e),this._onChange!==void 0&&this._onChange.call(this,{object:e.object,property:e.property,value:e.getValue(),controller:e})}onFinishChange(e){return this._onFinishChange=e,this}_callOnFinishChange(e){this.parent&&this.parent._callOnFinishChange(e),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:e.object,property:e.property,value:e.getValue(),controller:e})}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(e=>e.destroy())}controllersRecursive(){let e=Array.from(this.controllers);return this.folders.forEach(t=>{e=e.concat(t.controllersRecursive())}),e}foldersRecursive(){let e=Array.from(this.folders);return this.folders.forEach(t=>{e=e.concat(t.foldersRecursive())}),e}}function ql(s){return s*(Math.PI/180)}function K_(){const s=document.querySelector("#c"),e=new Xg({antialias:!0,canvas:s}),t=new po({title:"VisPTU Control Panel"}),n=45,i=2,r=.1,a=100,o=new gt(n,i,r,a);o.position.set(0,2,-8);const c=new R_(o,s);c.target.set(0,2,0),c.update();const l=new _u;let h;{l.background=new we("grey");const Q=16777215,ee=3,ue=new Tc(Q,ee);ue.position.set(0,10,0),ue.target.position.set(-5,0,0),l.add(ue),l.add(ue.target);const de=10,ie=new bc().load("assets/checker.png");ie.wrapS=Vn,ie.wrapT=Vn,ie.magFilter=At;const ce=de/2;ie.repeat.set(ce,ce);const re=new Ui(de,de),ae=new Cu({map:ie,side:Nt}),Te=new Pt(re,ae);Te.rotation.x=Math.PI*-.5,l.add(Te)}const u=new Tn,d=new Tn,p=new Yg;p.load("assets/rfr_body.glb",function(Q){l.add(Q.scene),Q.scene.getObjectByName("body")},void 0,function(Q){console.error(Q)}),p.load("assets/rfr_masthead.glb",function(Q){l.add(Q.scene),h=Q.scene.getObjectByName("masthead"),u.add(h)},void 0,function(Q){console.error(Q)});const g=38,x=1,m=1,f=2,T=4.88,b=.98,y=2.02,w=new gt(g,x,m,f),C=new gt(g,x,m,f),R=new gt(T,x,b,y),F=.25,S=.154,M=.155,P=-.02;w.position.set(-F,M,P),C.position.set(F,M,P),R.position.set(S,M,P);const k=.08;w.rotateY(-k),C.rotateY(k);const G=1,j=.98,X=2.02,Y=M-.07,$=new gt(G,x,j,X);$.position.set(S,Y,P);const z=45,le=1,pe=1.99,Ee=5,Oe=.05,qe=new gt(z,le,pe,Ee),Je=new gt(z,le,pe,Ee);qe.position.set(-Oe,M,P),Je.position.set(Oe,M,P);const We=new yi(w),W=new yi(C),K=new yi(R),me=new yi($),Ce=new yi(qe),ye=new yi(Je);l.add(We),l.add(W),l.add(K),l.add(me),l.add(Ce),l.add(ye),We.visible=!1,W.visible=!1,K.visible=!1,me.visible=!1,Ce.visible=!1,ye.visible=!1,u.add(w),u.add(C),u.add(R),u.add($),u.add(qe),u.add(Je),d.position.set(0,1.9,-.5),d.add(u),l.add(d);let He={value:0};function at(Q){d.rotation.y=ql(Q),He.value=Q}let A={value:0};function $e(Q){u.rotation.x=-1*ql(Q),A.value=Q}let De={pctRwac:function(){at(-43.5),$e(65.75)},pctLwac:function(){at(-70),$e(65.75)},parkPanCam:function(){at(0),$e(60)},homePTU:function(){at(0),$e(0)}};const be=t.addFolder("PTU Controls");be.add(He,"value").name("Pan (deg)").min(-180).max(180).onChange(Q=>{at(Q)}).listen(),be.add(A,"value").name("Tilt (deg)").min(-90).max(90).onChange(Q=>{$e(Q)}).listen(),be.add(De,"pctRwac").name("RWAC PCT"),be.add(De,"pctLwac").name("LWAC PCT"),be.add(De,"parkPanCam").name("Park PanCam"),be.add(De,"homePTU").name("Home PTU");let ve={visible:!1,viewFar:Ee};const Xe=t.addFolder("Camera Controls"),ge=.1,Ue=2,ct=10;Xe.add(w,"far",Ue,ct).name("LWAC distance area (m)").step(ge),Xe.add(C,"far",Ue,ct).name("RWAC distance area (m)").step(ge),Xe.add(R,"far",Ue,ct).name("HRC focus distance (m)").step(ge),Xe.add($,"far",Ue,ct).name("Enfys focus distance (m)").step(ge),Xe.add(ve,"viewFar").name("NavCams distance area (m)").step(ge).min(Ue).max(ct).onChange(Q=>{qe.far=Q,Je.far=Q}),Xe.add(We,"visible").name("Show LWAC"),Xe.add(W,"visible").name("Show RWAC"),Xe.add(K,"visible").name("Show HRC"),Xe.add(me,"visible").name("Show Enfys"),Xe.add(ve,"visible").name("Show NavCams").onChange(Q=>{Ce.visible=Q,ye.visible=Q});function Ke(Q,ee,ue,de){let Z=new D,ie=w.far,ce=new Le,re=new hn({color:8939110,side:Nt,transparent:!0,opacity:.4});de=="lwac"?(ie=w.far,w.getViewSize(ie,ce),w.getWorldPosition(Z)):de=="rwac"?(ie=C.far,C.getViewSize(ie,ce),C.getWorldPosition(Z),re=new hn({color:6719590,side:Nt,transparent:!0,opacity:.4})):de=="hrc"&&(re=new hn({color:6710920,side:Nt,transparent:!0,opacity:.4}),ie=R.far,R.getViewSize(ie,ce),R.getWorldPosition(Z));const ae=new Ui(ce.x,ce.y),Te=new Pt(ae,re);Te.position.copy(Q),Te.position.addScaledVector(ee,ie),Te.lookAt(Z),Te.name="panoElement",ue.add(Te)}let E=new ht;E.name="panoElements";function _(Q,ee,ue,de,Z,ie){let ce=new D,re=new D;if(ue-2>0){let ae=(ee-Q)/(ue-1),Te=Q;for(let L=0;L<ue;L++)L>0&&(Te+=ae),at(Te),de&&(w.getWorldDirection(ce),w.getWorldPosition(re),Ke(re,ce,E,"lwac")),Z&&(C.getWorldDirection(ce),C.getWorldPosition(re),Ke(re,ce,E,"rwac")),ie&&(R.getWorldDirection(ce),R.getWorldPosition(re),Ke(re,ce,E,"hrc"))}else at(Q),de&&(w.getWorldDirection(ce),w.getWorldPosition(re),Ke(re,ce,E,"lwac")),Z&&(C.getWorldDirection(ce),C.getWorldPosition(re),Ke(re,ce,E,"rwac")),ie&&(R.getWorldDirection(ce),R.getWorldPosition(re),Ke(re,ce,E,"hrc")),ee!=Q&&(at(ee),de&&(w.getWorldDirection(ce),w.getWorldPosition(re),Ke(re,ce,E,"lwac")),Z&&(C.getWorldDirection(ce),C.getWorldPosition(re),Ke(re,ce,E,"rwac")),ie&&(R.getWorldDirection(ce),R.getWorldPosition(re),Ke(re,ce,E,"hrc")));at(0),l.add(E)}const N=t.addFolder("Pan Panorama Planner (Fixed Tilt)");let H={start:0,stop:0,numPics:2,lwac:!1,rwac:!1,hrc:!1,panPlan:function(){_(this.start,this.stop,this.numPics,this.lwac,this.rwac,this.hrc)},clearPanPlan:function(){this.start=0,this.stop=0,this.numPics=2,this.lwac=!1,this.rwac=!1,this.hrc=!1,l.getObjectByName("panoElements")&&E.clear()}};N.add(H,"start").name("Pan Start (deg)").min(-180).max(180).listen(),N.add(H,"stop").name("Pan Stop (deg)").min(-180).max(180).listen(),N.add(H,"numPics",2,30,1).name("Number of Images").listen(),N.add(A,"value").name("Tilt (deg)").min(-90).max(90).onChange(Q=>{$e(Q)}).listen(),N.add(H,"lwac").name("Use LWAC").listen(),N.add(H,"rwac").name("Use RWAC").listen(),N.add(H,"hrc").name("Use HRC").listen(),N.add(H,"panPlan").name("Plan Pano"),N.add(H,"clearPanPlan").name("Clear Pano Plan");function J(Q){const ee=Q.domElement,ue=ee.clientWidth,de=ee.clientHeight,Z=ee.width!==ue||ee.height!==de;return Z&&Q.setSize(ue,de,!1),Z}function V(){J(e);const Q=e.domElement;o.aspect=Q.clientWidth/Q.clientHeight,o.updateProjectionMatrix(),w.updateProjectionMatrix(),C.updateProjectionMatrix(),R.updateProjectionMatrix(),$.updateProjectionMatrix(),qe.updateProjectionMatrix(),Je.updateProjectionMatrix(),We.update(),W.update(),K.update(),me.update(),Ce.update(),ye.update(),e.render(l,o),requestAnimationFrame(V)}requestAnimationFrame(V)}K_();
